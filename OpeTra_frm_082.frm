...
Begin VB.Form frm_Caj_CuoHip_02 
   ...
   Begin Threed.SSPanel SSPanel2 
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "OpeTra_frm_082.frx":000C
            Top             =   60
            Width           =   480
         End
      End
      ...
      Begin Threed.SSPanel SSPanel12 
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   13680
            Picture         =   "OpeTra_frm_082.frx":0316
            Style           =   1  'Graphical
            TabIndex        =   44
            ToolTipText     =   "Salir"
            Top             =   30
         ...
         Begin VB.CommandButton cmd_Grabar 
            Height          =   585
            Left            =   30
            Picture         =   "OpeTra_frm_082.frx":0758
            Style           =   1  'Graphical
            TabIndex        =   43
   ...
   End
End
Attribute VB_Name = "frm_Caj_CuoHip_02"
...
Private Sub cmd_Grabar_Click()
   ...
   Dim r_dbl_Deu_CapBBP    As Double
   Dim r_dbl_Deu_IntBBP    As Double
   ...
   Dim r_dbl_Pag_CapBBP    As Double
   Dim r_dbl_Pag_IntBBP    As Double
   ...
   Dim r_dbl_TotPag_Capita As Double
   Dim r_dbl_TotPag_Intere As Double
   Dim r_dbl_TotPag_SegDes As Double
   Dim r_dbl_TotPag_SegViv As Double
   Dim r_dbl_TotPag_OtrCar As Double
   Dim r_dbl_TotPag_CapBBP As Double
   Dim r_dbl_TotPag_IntBBP As Double
   Dim r_dbl_TotPag_IntCom As Double
   Dim r_dbl_TotPag_IntMor As Double
   Dim r_dbl_TotPag_GasCob As Double
   Dim r_dbl_TotPag_OtrGas As Double
   Dim r_dbl_TotPag_TotCuo As Double
   ...
   r_dbl_TotPag_Capita = 0
   r_dbl_TotPag_Intere = 0
   r_dbl_TotPag_SegDes = 0
   r_dbl_TotPag_SegViv = 0
   r_dbl_TotPag_OtrCar = 0
   r_dbl_TotPag_CapBBP = 0
   r_dbl_TotPag_IntBBP = 0
   r_dbl_TotPag_IntCom = 0
   r_dbl_TotPag_IntMor = 0
   r_dbl_TotPag_GasCob = 0
   r_dbl_TotPag_OtrGas = 0
   r_dbl_TotPag_TotCuo = 0
   ...
   For r_int_Contad = 0 To grd_Listad.Rows - 1
      ...
      grd_Listad.Col = 3:     r_dbl_Deu_Capita = CDbl(grd_Listad.Text)
      grd_Listad.Col = 4:     r_dbl_Deu_Intere = CDbl(grd_Listad.Text)
      grd_Listad.Col = 5:     r_dbl_Deu_SegDes = CDbl(grd_Listad.Text)
      grd_Listad.Col = 6:     r_dbl_Deu_SegViv = CDbl(grd_Listad.Text)
      grd_Listad.Col = 7:     r_dbl_Deu_OtrCar = CDbl(grd_Listad.Text)
      grd_Listad.Col = 8:     r_dbl_Deu_CapBBP = CDbl(grd_Listad.Text)
      grd_Listad.Col = 9:     r_dbl_Deu_IntBBP = CDbl(grd_Listad.Text)
      grd_Listad.Col = 10:    r_dbl_Deu_IntMor = CDbl(grd_Listad.Text)
      grd_Listad.Col = 11:    r_dbl_Deu_IntCom = CDbl(grd_Listad.Text)
      grd_Listad.Col = 12:    r_dbl_Deu_GasCob = CDbl(grd_Listad.Text)
      grd_Listad.Col = 13:    r_dbl_Deu_OtrGas = CDbl(grd_Listad.Text)
      grd_Listad.Col = 14:    r_dbl_Deu_TotCuo = CDbl(grd_Listad.Text)
      
      r_dbl_Pag_Capita = 0:   r_dbl_Pag_Intere = 0:   r_dbl_Pag_SegDes = 0:   r_dbl_Pag_SegViv = 0: r_dbl_Pag_OtrCar = 0:
      r_dbl_Pag_CapBBP = 0:   r_dbl_Pag_IntBBP = 0
      r_dbl_Pag_IntMor = 0:   r_dbl_Pag_IntCom = 0:   r_dbl_Pag_GasCob = 0:   r_dbl_Pag_OtrGas = 0
      r_dbl_Pag_TotCuo = 0
      ...
      'Interés Buen Pagador
      If r_dbl_Deu_IntBBP > 0 Then
         If r_dbl_SalPag > r_dbl_Deu_IntBBP Then
            r_dbl_SalPag = r_dbl_SalPag - r_dbl_Deu_IntBBP
            r_dbl_Pag_IntBBP = r_dbl_Deu_IntBBP
         Else
            r_dbl_Pag_IntBBP = r_dbl_SalPag
            r_dbl_SalPag = 0
         End If
         r_dbl_Pag_TotCuo = r_dbl_Pag_TotCuo + r_dbl_Pag_IntBBP
      End If
      
      'Capital Buen Pagador
      If r_dbl_Deu_CapBBP > 0 Then
         If r_dbl_SalPag > r_dbl_Deu_CapBBP Then
            r_dbl_SalPag = r_dbl_SalPag - r_dbl_Deu_CapBBP
            r_dbl_Pag_CapBBP = r_dbl_Deu_CapBBP
         Else
            r_dbl_Pag_CapBBP = r_dbl_SalPag
            r_dbl_SalPag = 0
         End If
         r_dbl_Pag_TotCuo = r_dbl_Pag_TotCuo + r_dbl_Pag_CapBBP
      End If
      ...
      'Totalizando
      r_dbl_TotPag_Capita = r_dbl_TotPag_Capita + r_dbl_Pag_Capita
      r_dbl_TotPag_Intere = r_dbl_TotPag_Intere + r_dbl_Pag_Intere
      r_dbl_TotPag_SegDes = r_dbl_TotPag_SegDes + r_dbl_Pag_SegDes
      r_dbl_TotPag_SegViv = r_dbl_TotPag_SegViv + r_dbl_Pag_SegViv
      r_dbl_TotPag_OtrCar = r_dbl_TotPag_OtrCar + r_dbl_Pag_OtrCar
      r_dbl_TotPag_CapBBP = r_dbl_TotPag_CapBBP + r_dbl_Pag_CapBBP
      r_dbl_TotPag_IntBBP = r_dbl_TotPag_IntBBP + r_dbl_Pag_IntBBP
      r_dbl_TotPag_IntCom = r_dbl_TotPag_IntCom + r_dbl_Pag_IntCom
      r_dbl_TotPag_IntMor = r_dbl_TotPag_IntMor + r_dbl_Pag_IntMor
      r_dbl_TotPag_GasCob = r_dbl_TotPag_GasCob + r_dbl_Pag_GasCob
      r_dbl_TotPag_OtrGas = r_dbl_TotPag_OtrGas + r_dbl_Pag_OtrGas
      r_dbl_TotPag_TotCuo = r_dbl_TotPag_TotCuo + r_dbl_Pag_TotCuo
      
      If Not opecaj_gf_Pago_Cuotas(moddat_g_str_NumOpe, r_int_NumCuo, Format(CDate(ipp_FecPag.Text), "yyyymmdd"), r_dbl_Pag_TotCuo, r_dbl_Pag_Capita, r_dbl_Pag_Intere, r_dbl_Pag_SegDes, r_dbl_Pag_SegViv, r_dbl_Pag_OtrCar, r_dbl_Pag_IntCom, r_dbl_Pag_IntMor, r_dbl_Pag_GasCob, r_dbl_Pag_OtrGas, 0, 0, l_int_SitCre, r_str_Operac, r_lng_NumMov, r_int_SitCuo, r_str_PrxVct, l_int_CuoPen, r_int_Situac, l_int_SitAnt, r_int_FlgCre, r_dbl_Pag_CapBBP, r_dbl_Pag_IntBBP) Then
      End If
   ...
   If r_dbl_SalPag > 0 Then
      ...
      For r_int_Contad = 0 To grd_CuoVig.Rows - 1
         ...
         grd_CuoVig.Col = 3:  r_dbl_Deu_Capita = CDbl(grd_CuoVig.Text)
         grd_CuoVig.Col = 4:  r_dbl_Deu_Intere = CDbl(grd_CuoVig.Text)
         grd_CuoVig.Col = 5:  r_dbl_Deu_SegDes = CDbl(grd_CuoVig.Text)
         grd_CuoVig.Col = 6:  r_dbl_Deu_SegViv = CDbl(grd_CuoVig.Text)
         grd_CuoVig.Col = 7:  r_dbl_Deu_OtrCar = CDbl(grd_CuoVig.Text)
         grd_CuoVig.Col = 8:  r_dbl_Deu_CapBBP = CDbl(grd_CuoVig.Text)
         grd_CuoVig.Col = 9:  r_dbl_Deu_IntBBP = CDbl(grd_CuoVig.Text)
         grd_CuoVig.Col = 10: r_dbl_Deu_TotCuo = CDbl(grd_CuoVig.Text)
   ...
   'Modificar SP de Registro de Movimiento en OPE_CAJMOV
   'Modificar en Tabla de Pagos CRE_HIPPAG y CRE_HIPCUO
   
   'Registrando Movimiento
   If Not opecaj_gf_Inserta_CajMov(modgen_g_str_CodUsu, "1102", moddat_g_str_NumOpe, "", moddat_g_int_TipDoc, moddat_g_str_NumDoc, l_arr_CodBan(cmb_CodBan.ListIndex + 1).Genera_Codigo, _
                                   Format(CDate(ipp_FecPag.Text), "yyyymmdd"), l_arr_CtaBan(cmb_CtaBan.ListIndex + 1).Genera_Codigo, txt_NumCom.Text, moddat_g_int_TipMon, CDbl(pnl_TotImp.Caption), _
                                   0, modgen_g_str_CodSuc, 0, 0, 0, l_dbl_PorITF, CDbl(pnl_ITFImp.Caption), CDbl(ipp_Import.Text), 0, "0", r_str_Operac, r_lng_NumMov, 1, "0", "", "", "", _
                                   r_dbl_TotPag_Capita, r_dbl_TotPag_Intere, r_dbl_TotPag_SegDes, r_dbl_TotPag_SegViv, r_dbl_TotPag_OtrCar, r_dbl_TotPag_CapBBP, r_dbl_TotPag_IntBBP, _
                                   r_dbl_TotPag_IntMor, r_dbl_TotPag_IntCom, r_dbl_TotPag_GasCob, r_dbl_TotPag_OtrGas, "", 0) Then
      Exit Sub
   End If
...
Private Sub fs_Inicia()
   ...
   grd_Listad.ColWidth(2) = 735
   grd_Listad.ColWidth(3) = 965
   ...
   grd_Listad.ColWidth(9) = 965
   grd_Listad.ColWidth(10) = 965
   grd_Listad.ColWidth(11) = 965
   grd_Listad.ColWidth(12) = 965
   grd_Listad.ColWidth(13) = 965
   grd_Listad.ColWidth(14) = 965
   ...
   grd_CuoVig.ColWidth(0) = 905
   grd_CuoVig.ColWidth(1) = 1415
   grd_CuoVig.ColWidth(2) = 725
   grd_CuoVig.ColWidth(3) = 1355
   grd_CuoVig.ColWidth(4) = 1355
   grd_CuoVig.ColWidth(5) = 1355
   grd_CuoVig.ColWidth(6) = 1355
   grd_CuoVig.ColWidth(7) = 1355
   grd_CuoVig.ColWidth(8) = 1355
   grd_CuoVig.ColWidth(9) = 1355
   grd_CuoVig.ColWidth(10) = 1365
   
   grd_CuoVig.ColAlignment(0) = flexAlignCenterCenter
   grd_CuoVig.ColAlignment(1) = flexAlignCenterCenter
   grd_CuoVig.ColAlignment(2) = flexAlignCenterCenter
   ...
   grd_CuoVig.ColAlignment(8) = flexAlignRightCenter
   grd_CuoVig.ColAlignment(9) = flexAlignRightCenter
   grd_CuoVig.ColAlignment(10) = flexAlignRightCenter
...
Private Sub fs_Buscar_Cuotas_Vencidas()
   ...
   If Not (g_rst_Princi.BOF And g_rst_Princi.EOF) Then
      ...
      Do While Not g_rst_Princi.EOF
         ...
         grd_Listad.Col = 2
         grd_Listad.Text = moddat_gf_Consulta_ParDes("229", CStr(moddat_g_int_TipMon))
      
         'Capital
         grd_Listad.Col = 3
         grd_Listad.Text = Format(g_rst_Princi!HIPCUO_CAPITA - g_rst_Princi!HIPCUO_CAPPAG, "###,###,##0.00")
         r_dbl_ValCuo = r_dbl_ValCuo + CDbl(grd_Listad.Text)
      
         'Interes
         grd_Listad.Col = 4
         grd_Listad.Text = Format(g_rst_Princi!HIPCUO_INTERE - g_rst_Princi!HIPCUO_INTPAG, "###,###,##0.00")
         r_dbl_ValCuo = r_dbl_ValCuo + CDbl(grd_Listad.Text)
         ...
         'Capital PBP
         grd_Listad.Col = 8
         grd_Listad.Text = Format(g_rst_Princi!HIPCUO_CAPBBP - g_rst_Princi!HIPCUO_CBPPAG, "###,###,##0.00")
         r_dbl_ValCuo = r_dbl_ValCuo + CDbl(grd_Listad.Text)
      
         'Interés PBP
         grd_Listad.Col = 9
         grd_Listad.Text = Format(g_rst_Princi!HIPCUO_INTBBP - g_rst_Princi!HIPCUO_IBPPAG, "###,###,##0.00")
         r_dbl_ValCuo = r_dbl_ValCuo + CDbl(grd_Listad.Text)
...
Private Sub fs_Buscar_Cuotas_Vigentes()
   ...
   If Not (g_rst_Princi.BOF And g_rst_Princi.EOF) Then
      ...
      Do While Not g_rst_Princi.EOF
         ...
         grd_CuoVig.Col = 2
         grd_CuoVig.Text = moddat_gf_Consulta_ParDes("229", CStr(moddat_g_int_TipMon))
         
         'Capital
         grd_CuoVig.Col = 3
         grd_CuoVig.Text = Format(g_rst_Princi!HIPCUO_CAPITA - g_rst_Princi!HIPCUO_CAPPAG, "###,###,##0.00")
         r_dbl_ValCuo = r_dbl_ValCuo + CDbl(grd_CuoVig.Text)
      
         'Interés
         grd_CuoVig.Col = 4
         grd_CuoVig.Text = Format(g_rst_Princi!HIPCUO_INTERE - g_rst_Princi!HIPCUO_INTPAG, "###,###,##0.00")
         r_dbl_ValCuo = r_dbl_ValCuo + CDbl(grd_CuoVig.Text)
         ...
         'Capital PBP
         grd_CuoVig.Col = 8
         grd_CuoVig.Text = Format(g_rst_Princi!HIPCUO_CAPBBP - g_rst_Princi!HIPCUO_CBPPAG, "###,###,##0.00")
         r_dbl_ValCuo = r_dbl_ValCuo + CDbl(grd_CuoVig.Text)
      
         'Interés PBP
         grd_CuoVig.Col = 9
         grd_CuoVig.Text = Format(g_rst_Princi!HIPCUO_INTBBP - g_rst_Princi!HIPCUO_IBPPAG, "###,###,##0.00")
         r_dbl_ValCuo = r_dbl_ValCuo + CDbl(grd_CuoVig.Text)
