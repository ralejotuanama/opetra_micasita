...
Begin VB.Form frm_Rpt_TraCof_09 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "OpeTra_frm_259.frx":000C
            Top             =   60
            Width           =   480
         End
      End
      Begin Threed.SSPanel SSPanel4 
         ...
         Begin VB.CommandButton cmd_Imprim 
            Height          =   585
            Left            =   30
            Picture         =   "OpeTra_frm_259.frx":0316
            Style           =   1  'Graphical
            TabIndex        =   4
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   7110
            Picture         =   "OpeTra_frm_259.frx":0758
            Style           =   1  'Graphical
            TabIndex        =   6
            ToolTipText     =   "Salir"
            Top             =   30
         ...
         Begin VB.CommandButton cmd_ExpExc 
            Height          =   585
            Left            =   630
            Picture         =   "OpeTra_frm_259.frx":0B9A
            Style           =   1  'Graphical
            TabIndex        =   5
   ...
   End
End
Attribute VB_Name = "frm_Rpt_TraCof_09"
...
Private Sub cmd_ExpExc_Click()
   ...
   If chk_ConHip.Value = 0 Then
      Call modmip_gs_Exc_ExcEva(62, 2, l_arr_ConHip(cmb_ConHip.ListIndex + 1).Genera_Codigo, Format(CDate(ipp_FecIni.Text), "yyyymmdd"), Format(CDate(ipp_FecFin.Text), "yyyymmdd"))
   Else
      Call modmip_gs_Exc_ExcEva(62, 2, "", Format(CDate(ipp_FecIni.Text), "yyyymmdd"), Format(CDate(ipp_FecFin.Text), "yyyymmdd"))
   End If
End Sub
