...
Begin VB.Form frm_GasAdm_03 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel2 
         ...
         Begin VB.CommandButton cmd_GasAdm 
            Height          =   675
            Left            =   12090
            Picture         =   "OpeTra_frm_049.frx":000C
            Style           =   1  'Graphical
            TabIndex        =   3
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   675
            Left            =   12780
            Picture         =   "OpeTra_frm_049.frx":08D6
            Style           =   1  'Graphical
            TabIndex        =   2
            ToolTipText     =   "Salida"
            Top             =   30
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin Threed.SSPanel SSPanel7 
            ...
            _ExtentY        =   873
            _StockProps     =   15
            Caption         =   "Gastos de Cierre - Conciliación"
            ForeColor       =   32768
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "MS Sans Serif"
               Size            =   12
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "OpeTra_frm_049.frx":0D18
            Top             =   60
            Width           =   480
         End
      End
   ...
   End
End
Attribute VB_Name = "frm_GasAdm_03"
...
Private Sub fs_Buscar()
   ...
   If Not (g_rst_Princi.BOF And g_rst_Princi.EOF) Then
      ...
      Do While Not g_rst_Princi.EOF
         ...
         g_str_Parame = "SELECT SUM(GASADM_PAGIMP) AS TOTGAS FROM TRA_GASADM WHERE "
         g_str_Parame = g_str_Parame & "GASADM_NUMSOL = '" & g_rst_Princi!SOLMAE_NUMERO & "' AND "
         g_str_Parame = g_str_Parame & "GASADM_SITUAC = 1 AND "
         ...
         If Not (g_rst_Genera.BOF And g_rst_Genera.EOF) And g_rst_Genera!TOTGAS > 0 Then
            ...
            grd_Listad.Col = 5
            grd_Listad.Text = Format(g_rst_Genera!TOTGAS, "###,###,##0.00")
   ...
   If grd_Listad.Rows = 0 Then
      ...
      MsgBox "No se encontraron Solicitudes Pendientes de Conciliación de Gastos de Cierre.", vbInformation, modgen_g_str_NomPlt
   Else
