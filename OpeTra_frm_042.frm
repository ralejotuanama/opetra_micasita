...
Begin VB.Form frm_TraMVi_02 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "OpeTra_frm_042.frx":00D0
            Top             =   60
            Width           =   480
         End
      End
      ...
      Begin Threed.SSPanel SSPanel39 
         ...
         Begin VB.CommandButton cmd_Rechaz 
            Height          =   675
            Left            =   10140
            Picture         =   "OpeTra_frm_042.frx":03DA
            Style           =   1  'Graphical
            TabIndex        =   27
         ...
         Begin VB.CommandButton cmd_Aprueb 
            Height          =   675
            Left            =   9450
            Picture         =   "OpeTra_frm_042.frx":081C
            Style           =   1  'Graphical
            TabIndex        =   26
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   675
            Left            =   10830
            Picture         =   "OpeTra_frm_042.frx":0B26
            Style           =   1  'Graphical
            TabIndex        =   25
            ToolTipText     =   "Salir"
            Top             =   30
      ...
      Begin Threed.SSPanel SSPanel11 
         ...
         Begin VB.CommandButton cmd_NueObs 
            Height          =   675
            Left            =   9450
            Picture         =   "OpeTra_frm_042.frx":0F70
            Style           =   1  'Graphical
            TabIndex        =   31
         ...
         Begin VB.CommandButton cmd_CanObs 
            Height          =   675
            Left            =   10830
            Picture         =   "OpeTra_frm_042.frx":13B2
            Style           =   1  'Graphical
            TabIndex        =   30
         ...
         Begin VB.CommandButton cmd_GraObs 
            Height          =   675
            Left            =   10140
            Picture         =   "OpeTra_frm_042.frx":16BC
            Style           =   1  'Graphical
            TabIndex        =   29
      ...
      Begin Threed.SSPanel SSPanel4 
         ...
         Begin VB.CommandButton cmd_Imprim 
            Height          =   675
            Left            =   30
            Picture         =   "OpeTra_frm_042.frx":1AFE
            Style           =   1  'Graphical
            TabIndex        =   48
            ToolTipText     =   "Imprimir Solicitud de CRC-PVP"
            Top             =   30
            Width           =   675
         End
         Begin VB.CommandButton cmd_RecMVi 
            Height          =   675
            Left            =   10800
            Picture         =   "OpeTra_frm_042.frx":1F40
            Style           =   1  'Graphical
            TabIndex        =   47
         ...
         Begin VB.CommandButton cmd_EnvMVi 
            Height          =   675
            Left            =   10110
            Picture         =   "OpeTra_frm_042.frx":280A
            Style           =   1  'Graphical
            TabIndex        =   42
   ...
   End
End
Attribute VB_Name = "frm_TraMVi_02"
...
Private Sub cmd_Aprueb_Click()
   ...
   Else
      ...
      modgen_g_str_Mail_Asunto = "APROBACION EN TRAMITES MIVIVIENDA Y POLIZAS DE SEGURO (" & Format(CDate(moddat_g_str_FecSis), "dd/mm/yyyy") & " - " & Format(Time, "hh:mm:ss") & ")"
...
Private Sub cmd_EnvMVi_Click()
   If grd_LisEva.Rows > 0 Then
      MsgBox "Ya registro el envío de Documentación al Fondo Mivivienda.", vbExclamation, modgen_g_str_NomPlt
      Exit Sub
   End If
   
   moddat_g_int_FlgAct = 1
   
   frm_TraMVi_03.Show 1
...
Private Sub fs_DatInm()
   ...
   If Not (g_rst_Princi.BOF And g_rst_Princi.EOF) Then
      ...
      'Para imprimir Formatos Mivivienda
...
Private Sub fs_Buscar_DatEva()
   ...
   If Not (g_rst_Princi.BOF And g_rst_Princi.EOF) Then
      ...
      grd_LisEva.Col = 1
      grd_LisEva.Text = gf_FormatoFecha(CStr(g_rst_Princi!EVAMVI_FECENV))
   
      If g_rst_Princi!EVAMVI_FECREC > 0 Then
         grd_LisEva.Rows = grd_LisEva.Rows + 1
         grd_LisEva.Row = grd_LisEva.Rows - 1
         grd_LisEva.Col = 0
         grd_LisEva.Text = "Fecha de Recepción"
   
         grd_LisEva.Col = 1
         grd_LisEva.Text = gf_FormatoFecha(CStr(g_rst_Princi!EVAMVI_FECREC))
      
         grd_LisEva.Rows = grd_LisEva.Rows + 1
         grd_LisEva.Row = grd_LisEva.Rows - 1
         grd_LisEva.Col = 0
         grd_LisEva.Text = "Nro. Expediente Mivivienda"
   
         grd_LisEva.Col = 1
         grd_LisEva.Text = Trim(g_rst_Princi!EVAMVI_CODMVI & "")
      
         txt_ObsEva.Text = Trim(g_rst_Princi!EVAMVI_OBSERV & "")
      End If
