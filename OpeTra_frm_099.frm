...
Begin VB.Form frm_LevCon_02 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel4 
         ...
         Begin TabDlg.SSTab tab_Seguim 
            ...
            TabPicture(0)   =   "OpeTra_frm_099.frx":000C
            ...
            TabPicture(1)   =   "OpeTra_frm_099.frx":0028
            ...
            TabPicture(2)   =   "OpeTra_frm_099.frx":0044
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "OpeTra_frm_099.frx":0074
            Top             =   60
            Width           =   480
         End
      End
      Begin Threed.SSPanel SSPanel36 
         ...
         Begin VB.CommandButton cmd_LevCon 
            Height          =   585
            Left            =   30
            Picture         =   "OpeTra_frm_099.frx":037E
            Style           =   1  'Graphical
            TabIndex        =   56
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   10920
            Picture         =   "OpeTra_frm_099.frx":07C0
            Style           =   1  'Graphical
            TabIndex        =   40
            ToolTipText     =   "Salir"
            Top             =   30
   ...
   End
End
Attribute VB_Name = "frm_LevCon_02"
...
Private Sub cmd_LevCon_Click()
   ...
   If moddat_g_int_FlgAct_1 = 2 Then
      ...
      If Not moddat_gf_Inserta_LevCon(moddat_g_str_NumSol, 41, moddat_g_str_Observ) Then
         Exit Sub
      End If
      ...
      modgen_g_str_Mail_Asunto = "TASACION DEL INMUEBLE - LEVANTAMIENTO DE CONDICIONES DE APROBACION (" & Format(CDate(moddat_g_str_FecSis), "dd/mm/yyyy") & " - " & Format(Time, "hh:mm:ss") & ")"
