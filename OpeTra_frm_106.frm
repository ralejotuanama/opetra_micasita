...
Begin VB.Form frm_TraCof_12 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "OpeTra_frm_106.frx":000C
            Top             =   60
            Width           =   480
         End
      End
      ...
      Begin Threed.SSPanel SSPanel4 
         ...
         Begin VB.CommandButton cmd_Grabar 
            Height          =   585
            Left            =   30
            Picture         =   "OpeTra_frm_106.frx":0316
            Style           =   1  'Graphical
            TabIndex        =   15
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   10560
            Picture         =   "OpeTra_frm_106.frx":0758
            Style           =   1  'Graphical
            TabIndex        =   14
            ToolTipText     =   "Salir"
            Top             =   30
   ...
   End
End
Attribute VB_Name = "frm_TraCof_12"
...
Private Sub cmd_Grabar_Click()
   If CDate(ipp_FecEnv.Text) > Date Then
      MsgBox "La Fecha de Envío no puede ser mayor a la Fecha Actual.", vbExclamation, modgen_g_str_NomPlt
   ...
   Do While moddat_g_int_FlgGOK = False
      ...
      g_str_Parame = "USP_TRA_EVACOF_ENVIAR ("
   ...
   If Not moddat_gf_Inserta_SegDet(moddat_g_str_NumSol, 62, 36, 0, "", 0, 0) Then
      Exit Sub
   End If
...
Private Sub fs_Buscar_DatEva()
   ...
   If Not (g_rst_Princi.BOF And g_rst_Princi.EOF) Then
      ...
      ipp_FecEnv.Text = gf_FormatoFecha(g_rst_Princi!EVACOF_FECENV)
   End If
