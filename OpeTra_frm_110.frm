...
Begin VB.Form frm_AutDes_11 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel4 
         ...
         Begin TabDlg.SSTab tab_Seguim 
            ...
            TabPicture(0)   =   "OpeTra_frm_110.frx":000C
            ...
            TabPicture(1)   =   "OpeTra_frm_110.frx":0028
            ...
            TabPicture(2)   =   "OpeTra_frm_110.frx":0044
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "OpeTra_frm_110.frx":0074
            Top             =   60
            Width           =   480
         End
      End
      Begin Threed.SSPanel SSPanel36 
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   10920
            Picture         =   "OpeTra_frm_110.frx":037E
            Style           =   1  'Graphical
            TabIndex        =   44
            ToolTipText     =   "Salir"
            Top             =   30
         ...
         Begin VB.CommandButton cmd_Aprueb 
            Height          =   585
            Left            =   630
            Picture         =   "OpeTra_frm_110.frx":07C0
            Style           =   1  'Graphical
            TabIndex        =   43
         ...
         Begin VB.CommandButton cmd_Rechaz 
            Height          =   585
            Left            =   1230
            Picture         =   "OpeTra_frm_110.frx":0ACA
            Style           =   1  'Graphical
            TabIndex        =   42
         ...
         Begin VB.CommandButton cmd_Excepc 
            Height          =   585
            Left            =   30
            Picture         =   "OpeTra_frm_110.frx":0F0C
            Style           =   1  'Graphical
            TabIndex        =   41
   ...
   End
End
Attribute VB_Name = "frm_AutDes_11"
...
Private Sub cmd_Aprueb_Click()
   ...
   modgen_g_str_Mail_Asunto = "AUTORIZACION DE DESEMBOLSO - APROBACION (" & Format(CDate(moddat_g_str_FecSis), "dd/mm/yyyy") & " - " & Format(Time, "hh:mm:ss") & ")"
...
Private Sub cmd_Excepc_Click()
   ...
   If moddat_g_int_FlgAct_1 = 2 Then
      ...
      'Enviando Correo Electrónico
      modgen_g_str_Mail_Asunto = "AUTORIZACION DE DESEMBOLSO - EXCEPCION (" & Format(CDate(moddat_g_str_FecSis), "dd/mm/yyyy") & " - " & Format(Time, "hh:mm:ss") & ")"
...
Private Sub cmd_Rechaz_Click()
   ...
   If moddat_g_int_MotRec > 0 Then
      ...
      modgen_g_str_Mail_Asunto = "AUTORIZACION DE DESEMBOLSO - RECHAZO (" & Format(CDate(moddat_g_str_FecSis), "dd/mm/yyyy") & " - " & Format(Time, "hh:mm:ss") & ")"
...
Private Sub Form_Load()
   ...
   Call fs_DatCof          'Datos de COFIDE
...
Private Sub fs_Buscar_LisOcu()
   ...
   g_str_Parame = g_str_Parame & "SEGDET_CODINS = 72 "
...
Private Sub fs_DatCof()
   ...
   If Not (g_rst_Princi.BOF And g_rst_Princi.EOF) Then
      ...
      grd_Listad(9).Col = 0
      grd_Listad(9).Text = "Fecha Envío"
      
      grd_Listad(9).Col = 1
      grd_Listad(9).Text = gf_FormatoFecha(CStr(g_rst_Princi!EVACOF_FECENV))
      ...
      If g_rst_Princi!EVACOF_FECREC > 0 Then
         If moddat_g_str_CodPrd = "003" Then
            ...
            grd_Listad(9).Row = grd_Listad(9).Rows - 1
            grd_Listad(9).Col = 0
            grd_Listad(9).Text = "Nro. Operación Mivivienda"
      
            grd_Listad(9).Col = 1
            grd_Listad(9).Text = Trim(g_rst_Princi!EVACOF_CODMV1 & "")
            
            grd_Listad(9).Rows = grd_Listad(9).Rows + 1
            grd_Listad(9).Row = grd_Listad(9).Rows - 1
            grd_Listad(9).Col = 0
            grd_Listad(9).Text = "Fecha Aprobación Mivivienda"
      
            grd_Listad(9).Col = 1
            grd_Listad(9).Text = gf_FormatoFecha(CStr(g_rst_Princi!EVACOF_APRMVI))
         End If
         ...
         grd_Listad(9).Row = grd_Listad(9).Rows - 1
         grd_Listad(9).Col = 0
         grd_Listad(9).Text = "Nro. Carta COFIDE"
   
         grd_Listad(9).Col = 1
         grd_Listad(9).Text = Trim(g_rst_Princi!EVACOF_NUMCAR & "")
         
         grd_Listad(9).Rows = grd_Listad(9).Rows + 1
         grd_Listad(9).Row = grd_Listad(9).Rows - 1
         grd_Listad(9).Col = 0
         grd_Listad(9).Text = "Fecha Recepción Carta COFIDE"
   
         grd_Listad(9).Col = 1
         grd_Listad(9).Text = gf_FormatoFecha(CStr(g_rst_Princi!EVACOF_FECREC))
      
         grd_Listad(9).Rows = grd_Listad(9).Rows + 1
         grd_Listad(9).Row = grd_Listad(9).Rows - 1
         grd_Listad(9).Col = 0
         grd_Listad(9).Text = "Nro. Operación COFIDE"
   
         grd_Listad(9).Col = 1
         grd_Listad(9).Text = Trim(g_rst_Princi!EVACOF_CODMVI & "")
      
         grd_Listad(9).Rows = grd_Listad(9).Rows + 1
         grd_Listad(9).Row = grd_Listad(9).Rows - 1
         grd_Listad(9).Col = 0
         grd_Listad(9).Text = "Fecha Desembolso COFIDE"
   
         grd_Listad(9).Col = 1
         grd_Listad(9).Text = gf_FormatoFecha(CStr(g_rst_Princi!EVACOF_FECDES))
         
         grd_Listad(9).Rows = grd_Listad(9).Rows + 1
         grd_Listad(9).Row = grd_Listad(9).Rows - 1
         grd_Listad(9).Col = 0
         grd_Listad(9).Text = "Importe Desembolsado"
   
         grd_Listad(9).Col = 1
         grd_Listad(9).CellFontName = "Lucida Console"
         grd_Listad(9).CellFontSize = 8
         grd_Listad(9).Text = moddat_gf_Consulta_ParDes("229", CStr(moddat_g_int_TipMon)) & " " & gf_FormatoNumero(g_rst_Princi!EVACOF_MTODES, 12, 2)
