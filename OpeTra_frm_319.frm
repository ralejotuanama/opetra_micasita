...
Begin VB.Form frm_Lev_TraCof_02 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel4 
         ...
         Begin TabDlg.SSTab tab_Seguim 
            ...
            TabPicture(0)   =   "OpeTra_frm_319.frx":000C
            ...
            TabPicture(1)   =   "OpeTra_frm_319.frx":0028
            ...
            TabPicture(2)   =   "OpeTra_frm_319.frx":0044
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin Threed.SSPanel pnl_TitSec 
            ...
            _ExtentY        =   556
            _StockProps     =   15
            Caption         =   "Trámites Mivivienda-Cofide"
            ForeColor       =   32768
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "MS Sans Serif"
               Size            =   8.26
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "OpeTra_frm_319.frx":0074
            Top             =   60
            Width           =   480
         End
      End
      Begin Threed.SSPanel SSPanel36 
         ...
         Begin VB.CommandButton cmd_LevCon 
            Height          =   585
            Left            =   30
            Picture         =   "OpeTra_frm_319.frx":037E
            Style           =   1  'Graphical
            TabIndex        =   67
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   11640
            Picture         =   "OpeTra_frm_319.frx":07C0
            Style           =   1  'Graphical
            TabIndex        =   40
            ToolTipText     =   "Salir"
            Top             =   30
   ...
   End
End
Attribute VB_Name = "frm_Lev_TraCof_02"
...
Private Sub cmd_LevCon_Click()
   ...
   If moddat_g_int_FlgAct_1 = 2 Then
      ...
      If Not moddat_gf_Inserta_LevCon(moddat_g_str_NumSol, 62, moddat_g_str_Observ) Then
         Exit Sub
      End If
      Screen.MousePointer = 0
      
      'Enviando Correo Electrónico
      modgen_g_str_Mail_Asunto = "TRAMITES MIVIVIENDA-COFIDE - LEVANTAMIENTO DE CONDICIONES DE APROBACION (Cliente: " & CStr(moddat_g_int_TipDoc) & "-" & moddat_g_str_NumDoc & " - " & moddat_g_str_NomCli & ")"
