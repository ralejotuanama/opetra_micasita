...
Begin VB.Form frm_PolSeg_11 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel4 
         ...
         Begin TabDlg.SSTab tab_Seguim 
            ...
            TabPicture(0)   =   "OpeTra_frm_102.frx":000C
            ...
            TabPicture(1)   =   "OpeTra_frm_102.frx":0028
            ...
            TabPicture(2)   =   "OpeTra_frm_102.frx":0044
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin Threed.SSPanel SSPanel7 
            ...
            _ExtentY        =   873
            _StockProps     =   15
            Caption         =   "Emisión de Pólizas de Seguro"
            ForeColor       =   32768
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "MS Sans Serif"
               Size            =   8.25
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "OpeTra_frm_102.frx":0074
            Top             =   60
            Width           =   480
         End
      End
      Begin Threed.SSPanel SSPanel36 
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   10920
            Picture         =   "OpeTra_frm_102.frx":037E
            Style           =   1  'Graphical
            TabIndex        =   47
            ToolTipText     =   "Salir"
            Top             =   30
         ...
         Begin VB.CommandButton cmd_Aprueb 
            Height          =   585
            Left            =   2430
            Picture         =   "OpeTra_frm_102.frx":07C0
            Style           =   1  'Graphical
            TabIndex        =   46
         ...
         Begin VB.CommandButton cmd_Rechaz 
            Height          =   585
            Left            =   3030
            Picture         =   "OpeTra_frm_102.frx":0ACA
            Style           =   1  'Graphical
            TabIndex        =   45
         ...
         Begin VB.CommandButton cmd_AprCon 
            Height          =   585
            Left            =   1830
            Picture         =   "OpeTra_frm_102.frx":0F0C
            Style           =   1  'Graphical
            TabIndex        =   44
         ...
         Begin VB.CommandButton cmd_Excepc 
            Height          =   585
            Left            =   1230
            Picture         =   "OpeTra_frm_102.frx":1216
            Style           =   1  'Graphical
            TabIndex        =   43
         ...
         Begin VB.CommandButton cmd_NueObs 
            Height          =   585
            Left            =   630
            Picture         =   "OpeTra_frm_102.frx":1520
            Style           =   1  'Graphical
            TabIndex        =   42
         ...
         Begin VB.CommandButton cmd_Evalua 
            Height          =   585
            Left            =   30
            Picture         =   "OpeTra_frm_102.frx":1962
            Style           =   1  'Graphical
            TabIndex        =   41
   ...
   End
End
Attribute VB_Name = "frm_PolSeg_11"
...
Private Sub cmd_AprCon_Click()
   ...
   If grd_LisEva.Rows = 0 Then
      MsgBox "No se ha registrado información de las Pólizas.", vbExclamation, modgen_g_str_NomPlt
      Exit Sub
   End If
   
   If moddat_gf_Valida_Observ(moddat_g_str_NumSol, 61) Then
   ...
   If Not moddat_gf_Inserta_AprCon(moddat_g_str_NumSol, 61, moddat_g_str_Observ) Then
      Exit Sub
   End If
   
   Call moddat_gs_FecSis
   r_int_DiaTra = CInt(CDate(moddat_g_str_FecSis) - CDate(moddat_gf_FecIng_Ins(moddat_g_str_NumSol, 61)))
   
   'Actualizando en Instancia
   If Not moddat_gf_Modifica_Seguim(moddat_g_str_NumSol, 61, r_int_DiaTra, 1, 1) Then
      Exit Sub
   End If
   
   'Creando Nueva Ocurrencia en Detalle de Seguimiento
   If Not moddat_gf_Inserta_SegDet(moddat_g_str_NumSol, 61, 12, 0, "", 0, 0) Then
      Exit Sub
   End If
   ...
   If moddat_g_str_CodPrd = "002" Then
      ...
      modgen_g_str_Mail_Asunto = "EMISION DE POLIZAS DE SEGURO - APROBACION CONDICIONADA (" & Format(CDate(moddat_g_str_FecSis), "dd/mm/yyyy") & " - " & Format(Time, "hh:mm:ss") & ")"
   ...
   Else
      ...
      Else
         ...
         modgen_g_str_Mail_Asunto = "EMISION DE POLIZAS DE SEGURO Y TRAMITES MIVIVIENDA-COFIDE - APROBACION CONDICIONADA (" & Format(CDate(moddat_g_str_FecSis), "dd/mm/yyyy") & " - " & Format(Time, "hh:mm:ss") & ")"
...
Private Sub cmd_Aprueb_Click()
   ...
   If grd_LisEva.Rows = 0 Then
      MsgBox "No se ha registrado información de los Contratos.", vbExclamation, modgen_g_str_NomPlt
      Exit Sub
   End If
   ...
   If moddat_g_str_CodPrd = "002" Then
      ...
      modgen_g_str_Mail_Asunto = "EMISION DE POLIZAS DE SEGURO - APROBACION (" & Format(CDate(moddat_g_str_FecSis), "dd/mm/yyyy") & " - " & Format(Time, "hh:mm:ss") & ")"
   ...
   Else
      ...
      Else
         ...
         modgen_g_str_Mail_Asunto = "EMISION DE POLIZAS DE SEGURO Y TRAMITES MIVIVIENDA-COFIDE - APROBACION (" & Format(CDate(moddat_g_str_FecSis), "dd/mm/yyyy") & " - " & Format(Time, "hh:mm:ss") & ")"
...
Private Sub cmd_Excepc_Click()
   ...
   If moddat_g_int_FlgAct_1 = 2 Then
      ...
      If Not moddat_gf_Inserta_SegDet(moddat_g_str_NumSol, 61, 18, 0, "", 0, 0) Then
         Exit Sub
      End If
      
      'Grabando en Detalle de Excepciones
      If Not moddat_gf_Inserta_SegExc(moddat_g_str_NumSol, 61, r_int_NumExc, moddat_g_str_Observ, moddat_g_int_TipAut) Then
         Exit Sub
      End If
      
      'Enviando Correo Electrónico
      modgen_g_str_Mail_Asunto = "EMISION DE POLIZAS DE SEGUROS - EXCEPCION (" & Format(CDate(moddat_g_str_FecSis), "dd/mm/yyyy") & " - " & Format(Time, "hh:mm:ss") & ")"
...
Private Sub cmd_NueObs_Click()
   ...
   If moddat_g_int_FlgAct_1 = 2 Then
      ...
      If moddat_g_int_TipObs = 1 Then
         ...
         g_str_Parame = g_str_Parame & "SEGDET_CODINS = 61 AND "
         ...
         'Grabando en Detalle de Seguimiento
         If Not moddat_gf_Inserta_SegDet(moddat_g_str_NumSol, 61, 21, CStr(r_int_NumObs), moddat_g_str_Observ, 1, 0) Then
            Exit Sub
         End If
         
         'Actualizando en Instancia si es una Observación
         If Not moddat_gf_Modifica_Seguim(moddat_g_str_NumSol, 61, 0, 3, 2) Then
            Exit Sub
         End If
   
         'Enviando Correo Electrónico
         modgen_g_str_Mail_Asunto = "EMISION DE POLIZAS DE SEGUROS - OBSERVACION (" & CStr(moddat_g_int_TipDoc) & "-" & moddat_g_str_NumDoc & " - " & moddat_g_str_NomCli & ")"
      Else
         modgen_g_str_Mail_Asunto = "EMISION DE POLIZAS DE SEGUROS - COMENTARIO (" & CStr(moddat_g_int_TipDoc) & "-" & moddat_g_str_NumDoc & " - " & moddat_g_str_NomCli & ")"
         
         'Grabando en Detalle de Seguimiento
         If Not moddat_gf_Inserta_SegDet(moddat_g_str_NumSol, 61, 17, 0, moddat_g_str_Observ, 0, 0) Then
            Exit Sub
         End If
      End If
...
Private Sub cmd_Rechaz_Click()
   ...
   If moddat_g_int_MotRec > 0 Then
      ...
      'Actualizando en Instancia
      If Not moddat_gf_Modifica_Seguim(moddat_g_str_NumSol, 61, r_int_DiaTra, 2, 1) Then
         Exit Sub
      End If
      
      'Creando Nueva Ocurrencia en Detalle de Seguimiento
      If Not moddat_gf_Inserta_SegDet(moddat_g_str_NumSol, 61, 13, 0, moddat_g_str_Observ, 0, moddat_g_int_MotRec) Then
         Exit Sub
      End If
      ...
      modgen_g_str_Mail_Asunto = "EMISION DE POLIZAS DE SEGUROS - RECHAZO (" & Format(CDate(moddat_g_str_FecSis), "dd/mm/yyyy") & " - " & Format(Time, "hh:mm:ss") & ")"
...
Private Sub fs_Buscar_LisOcu()
   ...
   g_str_Parame = "SELECT * FROM TRA_SEGDET WHERE "
   g_str_Parame = g_str_Parame & "SEGDET_NUMSOL = '" & moddat_g_str_NumSol & "' AND "
   g_str_Parame = g_str_Parame & "SEGDET_CODINS = 61 "
...
Private Sub fs_Buscar_DatEva()
   ...
   If Not (g_rst_Princi.BOF And g_rst_Princi.EOF) Then
      ...
      grd_LisEva.Col = 0
      grd_LisEva.Text = "Fecha Emisión Póliza Seg. Desgravamen"
      
      grd_LisEva.Col = 1
      grd_LisEva.Text = gf_FormatoFecha(CStr(g_rst_Princi!POLIZA_FEMDES))
   
      grd_LisEva.Rows = grd_LisEva.Rows + 1
      grd_LisEva.Row = grd_LisEva.Rows - 1
      grd_LisEva.Col = 0
      grd_LisEva.Text = "Nro. de Póliza (s)"

      grd_LisEva.Col = 1
      grd_LisEva.Text = Trim(g_rst_Princi!POLIZA_NUMDES & "") & IIf(Len(Trim(g_rst_Princi!POLIZA_NUMCYG & "")) = 0, "", " / " & Trim(g_rst_Princi!POLIZA_NUMCYG & ""))
      
      grd_LisEva.Rows = grd_LisEva.Rows + 2
      grd_LisEva.Row = grd_LisEva.Rows - 1
      grd_LisEva.Col = 0
      grd_LisEva.Text = "Fecha Emisión Póliza Seg. Vivienda"
      
      grd_LisEva.Col = 1
      grd_LisEva.Text = gf_FormatoFecha(CStr(g_rst_Princi!POLIZA_FEMVIV))
   
      grd_LisEva.Rows = grd_LisEva.Rows + 1
      grd_LisEva.Row = grd_LisEva.Rows - 1
      grd_LisEva.Col = 0
      grd_LisEva.Text = "Nro. de Póliza"

      grd_LisEva.Col = 1
      grd_LisEva.Text = Trim(g_rst_Princi!POLIZA_NUMVIV & "")
