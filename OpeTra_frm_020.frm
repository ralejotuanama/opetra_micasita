...
Begin VB.Form frm_EvaTas_01 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel2 
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   13410
            Picture         =   "OpeTra_frm_020.frx":000C
            Style           =   1  'Graphical
            TabIndex        =   3
            ToolTipText     =   "Salir"
            Top             =   30
         ...
         Begin VB.CommandButton cmd_Evalua 
            Height          =   585
            Left            =   30
            Picture         =   "OpeTra_frm_020.frx":044E
            Style           =   1  'Graphical
            TabIndex        =   2
            Top             =   30
            Width           =   585
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "OpeTra_frm_020.frx":0D18
            Top             =   60
            Width           =   480
         End
      End
   ...
   End
End
Attribute VB_Name = "frm_EvaTas_01"
...
Private Sub cmd_Evalua_Click()
   ...
   'frm_EvaTas_02.Show 1
   frm_EvaTas_11.Show 1
...
Private Sub fs_Buscar()
   ...
   If grd_Listad.Rows = 0 Then
      ...
      MsgBox "No se encontraron Solicitudes Pendientes de Tasación del Inmueble.", vbInformation, modgen_g_str_NomPlt
   Else
