...
Begin VB.Form frm_Lev_EvaSeg_02 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel4 
         ...
         Begin TabDlg.SSTab tab_Seguim 
            ...
            TabPicture(0)   =   "OpeTra_frm_315.frx":000C
            ...
            TabPicture(1)   =   "OpeTra_frm_315.frx":0028
            ...
            TabPicture(2)   =   "OpeTra_frm_315.frx":0044
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "OpeTra_frm_315.frx":0074
            Top             =   60
            Width           =   480
         End
      End
      Begin Threed.SSPanel SSPanel36 
         ...
         Begin VB.CommandButton cmd_LevCon 
            Height          =   585
            Left            =   30
            Picture         =   "OpeTra_frm_315.frx":037E
            Style           =   1  'Graphical
            TabIndex        =   63
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   10920
            Picture         =   "OpeTra_frm_315.frx":07C0
            Style           =   1  'Graphical
            TabIndex        =   42
            ToolTipText     =   "Salir"
            Top             =   30
   ...
   End
End
Attribute VB_Name = "frm_Lev_EvaSeg_02"
...
Private Sub cmd_LevCon_Click()
   ...
   If moddat_g_int_FlgAct_1 = 2 Then
      ...
      If Not moddat_gf_Inserta_LevCon(moddat_g_str_NumSol, 42, moddat_g_str_Observ) Then
         Exit Sub
      End If
      ...
      modgen_g_str_Mail_Asunto = "EVALUACION DE SEGUROS - LEVANTAMIENTO DE CONDICIONES DE APROBACION (Cliente: " & CStr(moddat_g_int_TipDoc) & "-" & moddat_g_str_NumDoc & " - " & moddat_g_str_NomCli & ")"
...
Private Sub Form_Load()
   ...
   moddat_g_str_CodEjeSeg = r_arr_Mtz(0).DatCom_FecSol
