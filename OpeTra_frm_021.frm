...
Begin VB.Form frm_EvaTas_02 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "OpeTra_frm_021.frx":00D0
            Top             =   60
            Width           =   480
         End
      End
      ...
      Begin Threed.SSPanel SSPanel39 
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   675
            Left            =   10830
            Picture         =   "OpeTra_frm_021.frx":03DA
            Style           =   1  'Graphical
            TabIndex        =   27
            ToolTipText     =   "Salir"
            Top             =   30
         ...
         Begin VB.CommandButton cmd_Aprueb 
            Height          =   675
            Left            =   9450
            Picture         =   "OpeTra_frm_021.frx":081C
            Style           =   1  'Graphical
            TabIndex        =   26
         ...
         Begin VB.CommandButton cmd_Rechaz 
            Height          =   675
            Left            =   10140
            Picture         =   "OpeTra_frm_021.frx":0B26
            Style           =   1  'Graphical
            TabIndex        =   25
      ...
      Begin Threed.SSPanel SSPanel11 
         ...
         Begin VB.CommandButton cmd_GraObs 
            Height          =   675
            Left            =   10140
            Picture         =   "OpeTra_frm_021.frx":0F68
            Style           =   1  'Graphical
            TabIndex        =   33
         ...
         Begin VB.CommandButton cmd_CanObs 
            Height          =   675
            Left            =   10830
            Picture         =   "OpeTra_frm_021.frx":13AA
            Style           =   1  'Graphical
            TabIndex        =   32
         ...
         Begin VB.CommandButton cmd_NueObs 
            Height          =   675
            Left            =   9450
            Picture         =   "OpeTra_frm_021.frx":16B4
            Style           =   1  'Graphical
            TabIndex        =   31
      ...
      Begin Threed.SSPanel SSPanel4 
         ...
         Begin VB.CommandButton cmd_DatInm 
            Height          =   675
            Left            =   720
            Picture         =   "OpeTra_frm_021.frx":1AFE
            Style           =   1  'Graphical
            TabIndex        =   48
            Top             =   30
            Width           =   675
         ...
         Begin VB.CommandButton cmd_Evalua 
            Height          =   675
            Left            =   10830
            Picture         =   "OpeTra_frm_021.frx":23C8
            Style           =   1  'Graphical
            TabIndex        =   43
            ToolTipText     =   "Grabar Datos"
            Top             =   30
         ...
         Begin VB.CommandButton cmd_Imprim 
            Height          =   675
            Left            =   30
            Picture         =   "OpeTra_frm_021.frx":2C92
            Style           =   1  'Graphical
            TabIndex        =   42
            Top             =   30
            Width           =   675
   ...
   End
End
Attribute VB_Name = "frm_EvaTas_02"
...
Dim l_str_DoiCli     As String
Dim l_str_NomCli     As String
Dim l_str_CelCli     As String
Dim l_str_TelCli     As String
...
Private Sub cmd_GraObs_Click()
   ...
   If Not moddat_gf_Inserta_SegDet(moddat_g_str_NumSol, 41, 21, CStr(grd_LisObs.Rows + 1), txt_Observ.Text, 1, 0) Then
      Exit Sub
   End If
   ...
   'Enviando Correo Electrónico
   modgen_g_str_Mail_Asunto = "OBSERVACION EN TASACION DEL INMUEBLE (" & Format(CDate(moddat_g_str_FecSis), "dd/mm/yyyy") & " - " & Format(Time, "hh:mm:ss") & ")"
...
Private Sub cmd_Imprim_Click()
   If grd_LisEva.Rows > 0 Then
      MsgBox "El Informe de Evaluación ya ha sido registrado. No se puede imprimir una Orden de Trabajo para un Informe ya registrado.", vbExclamation, modgen_g_str_NomPlt
      Exit Sub
   End If
   
   If MsgBox("¿Está seguro de imprimir la Orden de Trabajo para Peritaje del Inmueble?", vbQuestion + vbYesNo + vbDefaultButton2, modgen_g_str_NomPlt) <> vbYes Then
      Exit Sub
   End If
   ...
   moddat_g_bdt_Report.Execute "DELETE FROM RPT_TASAC1"
                        
   'Grabando en DAO
   moddat_g_str_CadDAO = "SELECT * FROM RPT_TASAC1 WHERE TASAC1_NUMSOL = '" & pnl_NumSol.Caption & "'"
   Set moddat_g_rst_RecDAO = moddat_g_bdt_Report.OpenRecordset(moddat_g_str_CadDAO, dbOpenDynaset)

   moddat_g_rst_RecDAO.AddNew
                        
   moddat_g_rst_RecDAO("TASAC1_NUMSOL") = pnl_NumSol.Caption
   moddat_g_rst_RecDAO("TASAC1_PRODUC") = moddat_g_str_NomPrd
   moddat_g_rst_RecDAO("TASAC1_MODALI") = l_str_Modali
   moddat_g_rst_RecDAO("TASAC1_VALVTA") = l_dbl_ValVta
   moddat_g_rst_RecDAO("TASAC1_MONEDA") = l_str_Moneda
   moddat_g_rst_RecDAO("TASAC1_TIPVIA") = l_str_TipVia
   moddat_g_rst_RecDAO("TASAC1_NOMVIA") = l_str_NomVia
   moddat_g_rst_RecDAO("TASAC1_INTDPT") = l_str_IntDpt
   moddat_g_rst_RecDAO("TASAC1_NUMVIA") = l_str_NumVia
   moddat_g_rst_RecDAO("TASAC1_ESTACI") = l_str_Estaci
   moddat_g_rst_RecDAO("TASAC1_TIPZON") = l_str_TipZon
   moddat_g_rst_RecDAO("TASAC1_NOMZON") = l_str_NomZon
   moddat_g_rst_RecDAO("TASAC1_DEPART") = l_str_Depart
   moddat_g_rst_RecDAO("TASAC1_PROVIN") = l_str_Provin
   moddat_g_rst_RecDAO("TASAC1_DISTRI") = l_str_Distri
   moddat_g_rst_RecDAO("TASAC1_REFERE") = l_str_Refere
   moddat_g_rst_RecDAO("TASAC1_NOMCLI") = l_str_NomCli
   moddat_g_rst_RecDAO("TASAC1_DOICLI") = l_str_DoiCli
   moddat_g_rst_RecDAO("TASAC1_TELCLI") = l_str_TelCli
   moddat_g_rst_RecDAO("TASAC1_CELCLI") = l_str_CelCli
   moddat_g_rst_RecDAO("TASAC1_NOMVEN") = l_str_NomVen
   moddat_g_rst_RecDAO("TASAC1_DOIVEN") = l_str_DoiVen
   moddat_g_rst_RecDAO("TASAC1_TELVEN") = l_str_TelVen
   ...
   crp_Imprim.ReportFileName = g_str_RutRpt & "\" & "OPE_ORDTAS_01.RPT"
   crp_Imprim.Action = 1
End Sub
...
Private Sub cmd_Rechaz_Click()
   ...
   If moddat_g_int_MotRec > 0 Then
      ...
      modgen_g_str_Mail_Asunto = "RECHAZO EN TASACION DEL INMUEBLE (" & Format(CDate(moddat_g_str_FecSis), "dd/mm/yyyy") & " - " & Format(Time, "hh:mm:ss") & ")"
...
Private Sub fs_Inicia()
   ...
   lbl_AprCon.Visible = False
   txt_AprCon.Visible = False
End Sub
...
Private Sub fs_DatCli(ByVal p_TipDoc As Integer, ByVal p_NumDoc As String, ByVal p_Indice As Integer)
   ...
   If Not (g_rst_Princi.BOF And g_rst_Princi.EOF) Then
      ...
      If p_Indice = 0 Then
         l_str_DoiCli = moddat_gf_Consulta_ParDes("203", CStr(g_rst_Princi!DatGen_TipDoc)) & " - " & Trim(g_rst_Princi!DatGen_NumDoc & "")
         l_str_NomCli = Trim(g_rst_Princi!DATGEN_APEPAT) & " " & Trim(g_rst_Princi!DATGEN_APEMAT) & IIf(Len(Trim(g_rst_Princi!DatGen_ApeCas)) > 0, " DE " & Trim(g_rst_Princi!DatGen_ApeCas), "") & " " & Trim(g_rst_Princi!DATGEN_NOMBRE)
         l_str_CelCli = Trim(g_rst_Princi!DATGEN_NUMCEL & "")
         l_str_TelCli = Trim(g_rst_Princi!DatGen_Telefo & "")
      End If
...
Private Sub fs_DatInm()
   ...
   If Not (g_rst_Princi.BOF And g_rst_Princi.EOF) Then
      ...
      'Datos para Impresión de formato
...
Private Sub fs_DatCre()
   ...
   l_str_Moneda = moddat_gf_Consulta_ParDes("204", CStr(g_rst_Princi!SOLMAE_COMVTA_MON))
   
   If g_rst_Princi!SOLMAE_COMVTA_MON = 1 Then
      l_dbl_ValVta = g_rst_Princi!SOLMAE_COMVTA_SOL
   ElseIf g_rst_Princi!SOLMAE_COMVTA_MON = 2 Then
...
Private Sub fs_Buscar_DatEva()
   ...
   If Not (g_rst_Princi.BOF And g_rst_Princi.EOF) Then
      ...
      grd_LisEva.Text = gf_FormatoNumero(g_rst_Princi!EVATAS_ARETER_INM + g_rst_Princi!EVATAS_ARETER_ES1 + g_rst_Princi!EVATAS_ARETER_ES2 + g_rst_Princi!EVATAS_ARETER_DEP, 12, 2)
      ...
      grd_LisEva.CellFontName = "Lucida Console"
      grd_LisEva.CellFontSize = 8
      grd_LisEva.Text = gf_FormatoNumero(g_rst_Princi!EVATAS_ARECON_INM + g_rst_Princi!EVATAS_ARECON_ES1 + g_rst_Princi!EVATAS_ARECON_ES2 + g_rst_Princi!EVATAS_ARECON_DEP, 12, 2)
      ...
      grd_LisEva.CellFontName = "Lucida Console"
      grd_LisEva.CellFontSize = 8
      grd_LisEva.Text = gf_FormatoNumero(g_rst_Princi!EVATAS_SUMASE_INM + g_rst_Princi!EVATAS_SUMASE_ES1 + g_rst_Princi!EVATAS_SUMASE_ES2 + g_rst_Princi!EVATAS_SUMASE_DEP, 12, 2)
      ...
      grd_LisEva.CellFontName = "Lucida Console"
      grd_LisEva.CellFontSize = 8
      grd_LisEva.Text = gf_FormatoNumero(g_rst_Princi!EVATAS_VALCOM_INM + g_rst_Princi!EVATAS_VALCOM_ES1 + g_rst_Princi!EVATAS_VALCOM_ES2 + g_rst_Princi!EVATAS_VALCOM_DEP, 12, 2)
      ...
      grd_LisEva.CellFontName = "Lucida Console"
      grd_LisEva.CellFontSize = 8
      grd_LisEva.Text = gf_FormatoNumero(g_rst_Princi!EVATAS_VALREA_INM + g_rst_Princi!EVATAS_VALREA_ES1 + g_rst_Princi!EVATAS_VALREA_ES2 + g_rst_Princi!EVATAS_VALREA_DEP, 12, 2)
      ...
      grd_LisEva.CellFontName = "Lucida Console"
      grd_LisEva.CellFontSize = 8
      grd_LisEva.Text = gf_FormatoNumero(g_rst_Princi!EVATAS_VALTER_INM + g_rst_Princi!EVATAS_VALTER_ES1 + g_rst_Princi!EVATAS_VALTER_ES2 + g_rst_Princi!EVATAS_VALTER_DEP, 12, 2)
      ...
      grd_LisEva.CellFontName = "Lucida Console"
      grd_LisEva.CellFontSize = 8
      grd_LisEva.Text = gf_FormatoNumero(g_rst_Princi!EVATAS_VALEDI_INM + g_rst_Princi!EVATAS_VALEDI_ES1 + g_rst_Princi!EVATAS_VALEDI_ES2 + g_rst_Princi!EVATAS_VALEDI_DEP, 12, 2)
      ...
      grd_LisEva.CellFontName = "Lucida Console"
      grd_LisEva.CellFontSize = 8
      grd_LisEva.Text = gf_FormatoNumero(g_rst_Princi!EVATAS_VALACO_INM + g_rst_Princi!EVATAS_VALACO_ES1 + g_rst_Princi!EVATAS_VALACO_ES2 + g_rst_Princi!EVATAS_VALACO_DEP, 12, 2)
      ...
      grd_LisEva.CellFontName = "Lucida Console"
      grd_LisEva.CellFontSize = 8
      grd_LisEva.Text = gf_FormatoNumero(g_rst_Princi!EVATAS_ARETER_INM, 12, 2)
      ...
      grd_LisEva.CellFontName = "Lucida Console"
      grd_LisEva.CellFontSize = 8
      grd_LisEva.Text = gf_FormatoNumero(g_rst_Princi!EVATAS_ARECON_INM, 12, 2)
      ...
      grd_LisEva.CellFontName = "Lucida Console"
      grd_LisEva.CellFontSize = 8
      grd_LisEva.Text = gf_FormatoNumero(g_rst_Princi!EVATAS_SUMASE_INM, 12, 2)
      ...
      grd_LisEva.CellFontName = "Lucida Console"
      grd_LisEva.CellFontSize = 8
      grd_LisEva.Text = gf_FormatoNumero(g_rst_Princi!EVATAS_VALCOM_INM, 12, 2)
      ...
      grd_LisEva.CellFontName = "Lucida Console"
      grd_LisEva.CellFontSize = 8
      grd_LisEva.Text = gf_FormatoNumero(g_rst_Princi!EVATAS_VALREA_INM, 12, 2)
      ...
      grd_LisEva.CellFontName = "Lucida Console"
      grd_LisEva.CellFontSize = 8
      grd_LisEva.Text = gf_FormatoNumero(g_rst_Princi!EVATAS_VALTER_INM, 12, 2)
      ...
      grd_LisEva.CellFontName = "Lucida Console"
      grd_LisEva.CellFontSize = 8
      grd_LisEva.Text = gf_FormatoNumero(g_rst_Princi!EVATAS_VALEDI_INM, 12, 2)
      ...
      grd_LisEva.CellFontName = "Lucida Console"
      grd_LisEva.CellFontSize = 8
      grd_LisEva.Text = gf_FormatoNumero(g_rst_Princi!EVATAS_VALACO_INM, 12, 2)
      ...
      If g_rst_Princi!EVATAS_FLGEST_ES1 = 1 Then
         ...
         grd_LisEva.CellFontName = "Lucida Console"
         grd_LisEva.CellFontSize = 8
         grd_LisEva.Text = gf_FormatoNumero(g_rst_Princi!EVATAS_ARETER_ES1, 12, 2)
         ...
         grd_LisEva.CellFontName = "Lucida Console"
         grd_LisEva.CellFontSize = 8
         grd_LisEva.Text = gf_FormatoNumero(g_rst_Princi!EVATAS_ARECON_ES1, 12, 2)
         ...
         grd_LisEva.CellFontName = "Lucida Console"
         grd_LisEva.CellFontSize = 8
         grd_LisEva.Text = gf_FormatoNumero(g_rst_Princi!EVATAS_SUMASE_ES1, 12, 2)
         ...
         grd_LisEva.CellFontName = "Lucida Console"
         grd_LisEva.CellFontSize = 8
         grd_LisEva.Text = gf_FormatoNumero(g_rst_Princi!EVATAS_VALCOM_ES1, 12, 2)
         ...
         grd_LisEva.CellFontName = "Lucida Console"
         grd_LisEva.CellFontSize = 8
         grd_LisEva.Text = gf_FormatoNumero(g_rst_Princi!EVATAS_VALREA_ES1, 12, 2)
         ...
         grd_LisEva.CellFontName = "Lucida Console"
         grd_LisEva.CellFontSize = 8
         grd_LisEva.Text = gf_FormatoNumero(g_rst_Princi!EVATAS_VALTER_ES1, 12, 2)
         ...
         grd_LisEva.CellFontName = "Lucida Console"
         grd_LisEva.CellFontSize = 8
         grd_LisEva.Text = gf_FormatoNumero(g_rst_Princi!EVATAS_VALEDI_ES1, 12, 2)
         ...
         grd_LisEva.CellFontName = "Lucida Console"
         grd_LisEva.CellFontSize = 8
         grd_LisEva.Text = gf_FormatoNumero(g_rst_Princi!EVATAS_VALACO_ES1, 12, 2)
      End If
      ...
      If g_rst_Princi!EVATAS_FLGEST_ES2 = 1 Then
         ...
         grd_LisEva.CellFontName = "Lucida Console"
         grd_LisEva.CellFontSize = 8
         grd_LisEva.Text = gf_FormatoNumero(g_rst_Princi!EVATAS_ARETER_ES2, 12, 2)
         ...
         grd_LisEva.CellFontName = "Lucida Console"
         grd_LisEva.CellFontSize = 8
         grd_LisEva.Text = gf_FormatoNumero(g_rst_Princi!EVATAS_ARECON_ES2, 12, 2)
         ...
         grd_LisEva.CellFontName = "Lucida Console"
         grd_LisEva.CellFontSize = 8
         grd_LisEva.Text = gf_FormatoNumero(g_rst_Princi!EVATAS_SUMASE_ES2, 12, 2)
         ...
         grd_LisEva.CellFontName = "Lucida Console"
         grd_LisEva.CellFontSize = 8
         grd_LisEva.Text = gf_FormatoNumero(g_rst_Princi!EVATAS_VALCOM_ES2, 12, 2)
         ...
         grd_LisEva.CellFontName = "Lucida Console"
         grd_LisEva.CellFontSize = 8
         grd_LisEva.Text = gf_FormatoNumero(g_rst_Princi!EVATAS_VALREA_ES2, 12, 2)
         ...
         grd_LisEva.CellFontName = "Lucida Console"
         grd_LisEva.CellFontSize = 8
         grd_LisEva.Text = gf_FormatoNumero(g_rst_Princi!EVATAS_VALTER_ES2, 12, 2)
         ...
         grd_LisEva.CellFontName = "Lucida Console"
         grd_LisEva.CellFontSize = 8
         grd_LisEva.Text = gf_FormatoNumero(g_rst_Princi!EVATAS_VALEDI_ES2, 12, 2)
         ...
         grd_LisEva.CellFontName = "Lucida Console"
         grd_LisEva.CellFontSize = 8
         grd_LisEva.Text = gf_FormatoNumero(g_rst_Princi!EVATAS_VALACO_ES2, 12, 2)
      End If
      ...
      If g_rst_Princi!EVATAS_FLGEST_DEP = 1 Then
         ...
         grd_LisEva.CellFontName = "Lucida Console"
         grd_LisEva.CellFontSize = 8
         grd_LisEva.Text = gf_FormatoNumero(g_rst_Princi!EVATAS_ARETER_DEP, 12, 2)
         ...
         grd_LisEva.CellFontName = "Lucida Console"
         grd_LisEva.CellFontSize = 8
         grd_LisEva.Text = gf_FormatoNumero(g_rst_Princi!EVATAS_ARECON_DEP, 12, 2)
         ...
         grd_LisEva.CellFontName = "Lucida Console"
         grd_LisEva.CellFontSize = 8
         grd_LisEva.Text = gf_FormatoNumero(g_rst_Princi!EVATAS_SUMASE_DEP, 12, 2)
         ...
         grd_LisEva.CellFontName = "Lucida Console"
         grd_LisEva.CellFontSize = 8
         grd_LisEva.Text = gf_FormatoNumero(g_rst_Princi!EVATAS_VALCOM_DEP, 12, 2)
         ...
         grd_LisEva.CellFontName = "Lucida Console"
         grd_LisEva.CellFontSize = 8
         grd_LisEva.Text = gf_FormatoNumero(g_rst_Princi!EVATAS_VALREA_DEP, 12, 2)
         ...
         grd_LisEva.CellFontName = "Lucida Console"
         grd_LisEva.CellFontSize = 8
         grd_LisEva.Text = gf_FormatoNumero(g_rst_Princi!EVATAS_VALTER_DEP, 12, 2)
         ...
         grd_LisEva.CellFontName = "Lucida Console"
         grd_LisEva.CellFontSize = 8
         grd_LisEva.Text = gf_FormatoNumero(g_rst_Princi!EVATAS_VALEDI_DEP, 12, 2)
         ...
         grd_LisEva.CellFontName = "Lucida Console"
         grd_LisEva.CellFontSize = 8
         grd_LisEva.Text = gf_FormatoNumero(g_rst_Princi!EVATAS_VALACO_DEP, 12, 2)
      End If
