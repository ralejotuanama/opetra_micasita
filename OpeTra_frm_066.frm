...
Begin VB.Form frm_CreRet_01 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel4 
         ...
         Begin VB.CommandButton cmd_Buscar 
            Height          =   675
            Left            =   5910
            Picture         =   "OpeTra_frm_066.frx":000C
            Style           =   1  'Graphical
            TabIndex        =   1
            Top             =   30
            Width           =   675
         ...
         Begin VB.CommandButton cmd_Limpia 
            Height          =   675
            Left            =   6600
            Picture         =   "OpeTra_frm_066.frx":0316
            Style           =   1  'Graphical
            TabIndex        =   2
            Top             =   30
            Width           =   675
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   675
            Left            =   7290
            Picture         =   "OpeTra_frm_066.frx":0620
            Style           =   1  'Graphical
            TabIndex        =   3
            Top             =   30
            Width           =   675
      ...
      Begin Threed.SSPanel SSPanel3 
         ...
         Begin VB.CommandButton cmd_LimOpe 
            Height          =   675
            Left            =   7290
            Picture         =   "OpeTra_frm_066.frx":0A62
            Style           =   1  'Graphical
            TabIndex        =   7
            Top             =   30
            Width           =   675
         ...
         Begin VB.CommandButton cmd_BusOpe 
            Height          =   675
            Left            =   6600
            Picture         =   "OpeTra_frm_066.frx":0D6C
            Style           =   1  'Graphical
            TabIndex        =   6
            Top             =   30
            Width           =   675
      ...
      Begin Threed.SSPanel SSPanel2 
         ...
         Begin VB.CommandButton cmd_BusCli 
            Height          =   675
            Left            =   6600
            Picture         =   "OpeTra_frm_066.frx":1076
            Style           =   1  'Graphical
            TabIndex        =   11
            Top             =   30
            Width           =   675
         ...
         Begin VB.CommandButton cmd_LimCli 
            Height          =   675
            Left            =   7290
            Picture         =   "OpeTra_frm_066.frx":1380
            Style           =   1  'Graphical
            TabIndex        =   12
            Top             =   30
            Width           =   675
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin Threed.SSPanel SSPanel7 
            ...
            _ExtentY        =   1085
            _StockProps     =   15
            Caption         =   "Créditos Hipotecarios - Operaciones con Retención de Fondos"
            ForeColor       =   32768
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "MS Sans Serif"
               Size            =   12
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "OpeTra_frm_066.frx":168A
            Top             =   60
            Width           =   480
         End
      End
   ...
   End
End
Attribute VB_Name = "frm_CreRet_01"
...
Private Sub cmd_Buscar_Click()
   ...
   If g_rst_Princi.BOF And g_rst_Princi.EOF Then
      MsgBox "No existe ninguna Operación registrada con este Número. ", vbExclamation, modgen_g_con_OpeTra
   ...
   Else
      If g_rst_Princi!HIPMAE_SITUAC = 9 Then
         MsgBox "La Operación se encuentra cancelada.", vbExclamation, modgen_g_con_OpeTra
      ...
      'Validando que no tenga Hipoteca o Bloqueo Registral registrado
      If g_rst_Princi!HIPMAE_TIPGAR <> 6 Then
         MsgBox "La Operación no fue desembolsada con RETENCION DE FONDOS.", vbExclamation, modgen_g_con_OpeTra
      ...
      moddat_g_str_NomPrd = moddat_gf_Consulta_Produc(g_rst_Princi!HIPMAE_CODPRD)
      moddat_g_str_NumSol = g_rst_Princi!HIPMAE_NUMSOL
      moddat_g_str_NumOpe = g_rst_Princi!HIPMAE_NUMOPE
      ...
      moddat_g_str_CodPrd = g_rst_Princi!HIPMAE_CODPRD
      moddat_g_str_CodSub = g_rst_Princi!HIPMAE_CODSUB
...
Private Sub cmd_BusCli_Click()
   ...
   If g_rst_Princi.BOF And g_rst_Princi.EOF Then
      MsgBox "No se han encontrado clientes para esa selección.", vbExclamation, modgen_g_con_AteCli
