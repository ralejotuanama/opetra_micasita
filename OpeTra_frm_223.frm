...
Begin VB.Form frm_Tra_EvaTas_01 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel2 
         ...
         Begin VB.CommandButton cmd_Export 
            Height          =   585
            Left            =   630
            Picture         =   "OpeTra_frm_223.frx":000C
            Style           =   1  'Graphical
            TabIndex        =   3
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   13410
            Picture         =   "OpeTra_frm_223.frx":0316
            Style           =   1  'Graphical
            TabIndex        =   4
            ToolTipText     =   "Salir"
            Top             =   30
         ...
         Begin VB.CommandButton cmd_EvaSol 
            Height          =   585
            Left            =   30
            Picture         =   "OpeTra_frm_223.frx":0758
            Style           =   1  'Graphical
            TabIndex        =   2
            Top             =   30
            Width           =   585
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "OpeTra_frm_223.frx":1022
            Top             =   60
            Width           =   480
         End
      End
      Begin Threed.SSPanel SSPanel4 
         ...
         Begin Threed.SSPanel SSPanel7 
            ...
            _ExtentY        =   556
            _StockProps     =   15
            Caption         =   "TASACION REGISTRADA - EN EVALUACION"
            ForeColor       =   32768
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "MS Sans Serif"
               Size            =   8.25
            ...
            Alignment       =   1
         End
         Begin Threed.SSPanel pnl_TasReg_Eva 
            Height          =   315
            Left            =   7680
            TabIndex        =   13
            Top             =   480
         ...
         Begin Threed.SSPanel pnl_OpeNue 
            ...
            Alignment       =   4
         End
         Begin Threed.SSPanel pnl_OrdGen 
            Height          =   315
            Left            =   7680
            TabIndex        =   15
            Top             =   120
            ...
            Alignment       =   4
         End
         Begin Threed.SSPanel pnl_SinOrd 
            Height          =   315
            Left            =   2520
            TabIndex        =   16
            Top             =   480
            ...
            Alignment       =   4
         End
         Begin Threed.SSPanel pnl_TasReg_Obs 
            Height          =   315
            Left            =   12480
            TabIndex        =   17
            Top             =   120
         ...
         Begin Threed.SSPanel SSPanel11 
            ...
            _ExtentY        =   556
            _StockProps     =   15
            Caption         =   "ORDEN DE TASACION GENERADA"
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "MS Sans Serif"
               Size            =   8.25
               Charset         =   0
         ...
         Begin Threed.SSPanel SSPanel13 
            ...
            _ExtentY        =   556
            _StockProps     =   15
            Caption         =   "TASACION REGISTRADA - OBSERVADA"
            ForeColor       =   16711680
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "MS Sans Serif"
               Size            =   8.25
   ...
   End
End
Attribute VB_Name = "frm_Tra_EvaTas_01"
...
Dim l_int_SinOrd        As Integer
Dim l_int_OrdGen        As Integer
Dim l_int_TasReg_Eva    As Integer
Dim l_int_TasReg_Obs    As Integer
...
Dim r_int_fila       As Integer
   ...
   With r_obj_Excel.ActiveSheet
      ...
      .Cells(r_int_NroFil, 1) = "RELACION DE SOLICITUDES EN TASACION"
...
Private Sub fs_Buscar()
   ...
   g_str_Parame = ""
   g_str_Parame = g_str_Parame & " SELECT SOLMAE_CODPRD, SOLMAE_NUMERO, SOLMAE_TITTDO, SOLMAE_TITNDO, SOLMAE_FECSOL, SEGUIM_FECINI, "
   g_str_Parame = g_str_Parame & "        SEGUIM_SITUAC, SOLMAE_CONHIP, SOLMAE_CODSUB, SOLMAE_TIPMON, SEGUIM_FECINI, TRIM(E.PARDES_DESCRI) AS SITUACION, "
   g_str_Parame = g_str_Parame & "        (TRIM(C.DATGEN_APEPAT)||' '||Trim(C.DATGEN_APEMAT)||' '||Trim(C.DATGEN_NOMBRE)) AS NOM_CLIENTE, "
   g_str_Parame = g_str_Parame & "        (SELECT TRIM(PRODUC_DESCRI) FROM CRE_PRODUC WHERE PRODUC_CODIGO = LPAD(A.SOLMAE_CODPRD,3,'0')) AS NOM_PRODUCTO "
   g_str_Parame = g_str_Parame & "   FROM CRE_SOLMAE A "
   g_str_Parame = g_str_Parame & "  INNER JOIN TRA_SEGUIM B ON B.SEGUIM_NUMSOL = A.SOLMAE_NUMERO AND B.SEGUIM_CODINS = 41 AND (B.SEGUIM_SITUAC = 9 OR B.SEGUIM_SITUAC = 3) "
   g_str_Parame = g_str_Parame & "  INNER JOIN CLI_DATGEN C ON C.DATGEN_TIPDOC = A.SOLMAE_TITTDO AND C.DATGEN_NUMDOC = A.SOLMAE_TITNDO "
   g_str_Parame = g_str_Parame & "  INNER JOIN MNT_PARDES E ON E.PARDES_CODGRP = 23 AND E.PARDES_CODITE = B.SEGUIM_SITUAC "
   ...
   If Not (g_rst_Princi.BOF And g_rst_Princi.EOF) Then
      ...
      Do While Not g_rst_Princi.EOF
         ...
         'g_str_Parame = g_str_Parame & "SEGUIM_CODINS = 41 AND "
         ...
         '   g_rst_Genera.MoveFirst
            ...
            If grd_Listad.Text = "" Then
               grd_Listad.Text = "SIN ORDEN DE TASACION"
               l_int_SinOrd = l_int_SinOrd + 1
      ...
      pnl_SinOrd.Caption = l_int_SinOrd & " "
      pnl_OrdGen.Caption = l_int_OrdGen & " "
      pnl_TasReg_Eva.Caption = l_int_TasReg_Eva & " "
      pnl_TasReg_Obs.Caption = l_int_TasReg_Obs & " "
      pnl_TotReg.Caption = l_int_OpeNue + l_int_SinOrd + l_int_OrdGen + l_int_TasReg_Eva + l_int_TasReg_Obs & " "
...
Private Function fs_Buscar_SituacOper(ByVal p_NumSol As String) As String
   ...
   g_str_Parame = ""
   g_str_Parame = g_str_Parame & "SELECT SEGDET_CODOCU, (SELECT COUNT(*) FROM TRA_SEGDET WHERE SEGDET_NUMSOL = '" & p_NumSol & "' AND SEGDET_CODINS = 41) AS CONTADOR"
   g_str_Parame = g_str_Parame & "  FROM TRA_SEGDET "
   g_str_Parame = g_str_Parame & " WHERE SEGDET_NUMSOL = '" & p_NumSol & "' "
   g_str_Parame = g_str_Parame & "   AND SEGDET_CODINS = 41 "
   ...
   Do While Not g_rst_GenAux.EOF
      If g_rst_GenAux!CONTADOR = 1 Then
         fs_Buscar_SituacOper = "OPERACION NUEVA" 'moddat_gf_Consulta_ParDes("004", Format(g_rst_GenAux!SEGDET_CODOCU, "000000"))
         l_int_OpeNue = l_int_OpeNue + 1
         grd_Listad.CellForeColor = modgen_g_con_ColRoj
         
      ElseIf g_rst_GenAux!SEGDET_CODOCU = 33 Then
         fs_Buscar_SituacOper = "ORDEN DE TASACION GENERADA"
         l_int_OrdGen = l_int_OrdGen + 1
         grd_Listad.CellForeColor = modgen_g_con_ColNeg
         g_rst_GenAux.Close
         Set g_rst_GenAux = Nothing
         Exit Function
         
      ElseIf g_rst_GenAux!SEGDET_CODOCU = 34 Then
         grd_Listad.Col = 6
         If grd_Listad.Text = "OBSERVADA" Then
            grd_Listad.Col = 7
            l_int_TasReg_Obs = l_int_TasReg_Obs + 1
            grd_Listad.CellForeColor = modgen_g_con_ColAzu
         Else
            grd_Listad.Col = 7
            l_int_TasReg_Eva = l_int_TasReg_Eva + 1
            grd_Listad.CellForeColor = modgen_g_con_ColVer
         End If
         fs_Buscar_SituacOper = "TASACION REGISTRADA"
         g_rst_GenAux.Close
         Set g_rst_GenAux = Nothing
         Exit Function
      End If
