   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin Threed.SSPanel SSPanel7 
            ...
            _ExtentY        =   450
            _StockProps     =   15
            Caption         =   "Actividades Económicas - Dependiente o Pensionista"
            ForeColor       =   32768
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "MS Sans Serif"
               Size            =   8.25
...
Private Sub cmd_Grabar_Click()
   ...
   If cmb_SitTra.ListIndex = -1 Then
      MsgBox "Debe seleccionar la Situación del Trabajador.", vbExclamation, modgen_g_str_NomPlt
   ...
   g_str_Parame = g_str_Parame & CStr(cmb_SitTra.ItemData(cmb_SitTra.ListIndex)) & ", "      'Situación Trabajador
   
   If cmb_TipOfi.ItemData(cmb_TipOfi.ListIndex) = 1 Then
      g_str_Parame = g_str_Parame & CStr(l_int_TipVia) & ", "                                'Tipo de Via
      g_str_Parame = g_str_Parame & "'" & l_str_NomVia & "', "                               'Nombre de Vía
      g_str_Parame = g_str_Parame & "'" & l_str_NumVia & "', "                               'Número de Vía
      ...
      g_str_Parame = g_str_Parame & "'" & l_str_UbiGeo & "', "                               'Ubicación Geográfica
      g_str_Parame = g_str_Parame & "'" & l_str_Refere & "', "                               'Referencia
      g_str_Parame = g_str_Parame & "'" & l_str_Telef1 & "', "                               'Teléfono 1
      g_str_Parame = g_str_Parame & "'" & l_str_Telef2 & "', "                               'Teléfono 2
      g_str_Parame = g_str_Parame & "'" & l_str_NumFax & "', "                               'Número de Fax
   Else
   ...
   g_str_Parame = g_str_Parame & "'" & txt_NumAnx.Text & "', "                            'Número de Anexo
   g_str_Parame = g_str_Parame & "'" & txt_TelDir.Text & "', "                            'Teléfono Directo
