...
Begin VB.Form frm_EvaTas_11 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel4 
         ...
         Begin TabDlg.SSTab tab_Seguim 
            ...
            TabPicture(0)   =   "OpeTra_frm_086.frx":000C
            ...
            TabPicture(1)   =   "OpeTra_frm_086.frx":0028
            ...
            TabPicture(2)   =   "OpeTra_frm_086.frx":0044
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "OpeTra_frm_086.frx":0074
            Top             =   60
            Width           =   480
         End
      End
      Begin Threed.SSPanel SSPanel36 
         ...
         Begin VB.CommandButton cmd_OrdTas 
            Height          =   585
            Left            =   30
            Picture         =   "OpeTra_frm_086.frx":037E
            Style           =   1  'Graphical
            TabIndex        =   58
         ...
         Begin VB.CommandButton cmd_DatInm 
            Height          =   585
            Left            =   1230
            Picture         =   "OpeTra_frm_086.frx":0688
            Style           =   1  'Graphical
            TabIndex        =   57
         ...
         Begin VB.CommandButton cmd_Evalua 
            Height          =   585
            Left            =   630
            Picture         =   "OpeTra_frm_086.frx":0F52
            Style           =   1  'Graphical
            TabIndex        =   56
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   10920
            Picture         =   "OpeTra_frm_086.frx":181C
            Style           =   1  'Graphical
            TabIndex        =   46
            ToolTipText     =   "Salir"
            Top             =   30
         ...
         Begin VB.CommandButton cmd_Aprueb 
            Height          =   585
            Left            =   3630
            Picture         =   "OpeTra_frm_086.frx":1C5E
            Style           =   1  'Graphical
            TabIndex        =   45
         ...
         Begin VB.CommandButton cmd_Rechaz 
            Height          =   585
            Left            =   4230
            Picture         =   "OpeTra_frm_086.frx":1F68
            Style           =   1  'Graphical
            TabIndex        =   44
         ...
         Begin VB.CommandButton cmd_AprCon 
            Height          =   585
            Left            =   3030
            Picture         =   "OpeTra_frm_086.frx":23AA
            Style           =   1  'Graphical
            TabIndex        =   43
         ...
         Begin VB.CommandButton cmd_Excepc 
            Height          =   585
            Left            =   2430
            Picture         =   "OpeTra_frm_086.frx":26B4
            Style           =   1  'Graphical
            TabIndex        =   42
         ...
         Begin VB.CommandButton cmd_NueObs 
            Height          =   585
            Left            =   1830
            Picture         =   "OpeTra_frm_086.frx":29BE
            Style           =   1  'Graphical
            TabIndex        =   41
   ...
   End
End
Attribute VB_Name = "frm_EvaTas_11"
...
Private Sub cmd_AprCon_Click()
   ...
   Else
      ...
      modgen_g_str_Mail_Asunto = "TASACION DEL INMUEBLE Y EVALUACION DE SEGUROS - APROBACION CONDICIONADA (" & Format(CDate(moddat_g_str_FecSis), "dd/mm/yyyy") & " - " & Format(Time, "hh:mm:ss") & ")"
...
Private Sub cmd_Aprueb_Click()
   ...
   Else
      ...
      'Enviando Correo Electrónico
      modgen_g_str_Mail_Asunto = "TASACION DEL INMUEBLE Y EVALUACION DE SEGUROS - APROBACION (" & Format(CDate(moddat_g_str_FecSis), "dd/mm/yyyy") & " - " & Format(Time, "hh:mm:ss") & ")"
...
Private Sub cmd_Excepc_Click()
   ...
   If moddat_g_int_FlgAct_1 = 2 Then
      ...
      'Enviando Correo Electrónico
      modgen_g_str_Mail_Asunto = "TASACION DEL INMUEBLE - EXCEPCION (" & Format(CDate(moddat_g_str_FecSis), "dd/mm/yyyy") & " - " & Format(Time, "hh:mm:ss") & ")"
...
Private Sub cmd_Rechaz_Click()
   ...
   If moddat_g_int_MotRec > 0 Then
      ...
      modgen_g_str_Mail_Asunto = "TASACION DEL INMUEBLE - RECHAZO (" & Format(CDate(moddat_g_str_FecSis), "dd/mm/yyyy") & " - " & Format(Time, "hh:mm:ss") & ")"
