...
Begin VB.Form frm_AutDes_02 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel2 
         ...
         Begin TabDlg.SSTab SSTab1 
            ...
            TabPicture(6)   =   "OpeTra_frm_030.frx":00B4
            ...
            TabPicture(7)   =   "OpeTra_frm_030.frx":00D0
            Tab(7).ControlEnabled=   0   'False
            Tab(7).Control(0)=   "grd_Listad(6)"
            Tab(7).ControlCount=   1
            TabCaption(8)   =   "Tasación del Inmueble"
            TabPicture(8)   =   "OpeTra_frm_030.frx":00EC
            ...
            TabPicture(9)   =   "OpeTra_frm_030.frx":0108
            ...
            TabPicture(10)  =   "OpeTra_frm_030.frx":0124
            Tab(10).ControlEnabled=   0   'False
            Tab(10).Control(0)=   "SSPanel3"
            Tab(10).Control(1)=   "txt_ComCre"
            Tab(10).Control(2)=   "txt_InfLeg"
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "OpeTra_frm_030.frx":016C
            Top             =   60
            Width           =   480
         End
      End
      ...
      Begin Threed.SSPanel SSPanel39 
         ...
         Begin VB.CommandButton cmd_Rechaz 
            Height          =   675
            Left            =   10140
            Picture         =   "OpeTra_frm_030.frx":0476
            Style           =   1  'Graphical
            TabIndex        =   23
         ...
         Begin VB.CommandButton cmd_Aprueb 
            Height          =   675
            Left            =   9450
            Picture         =   "OpeTra_frm_030.frx":08B8
            Style           =   1  'Graphical
            TabIndex        =   22
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   675
            Left            =   10830
            Picture         =   "OpeTra_frm_030.frx":0BC2
            Style           =   1  'Graphical
            TabIndex        =   21
            ToolTipText     =   "Salir"
            Top             =   30
   ...
   End
End
Attribute VB_Name = "frm_AutDes_02"
...
Private Sub cmd_Aprueb_Click()
   ...
   modgen_g_str_Mail_Asunto = "APROBACION EN AUTORIZACION DE DESEMBOLSO (" & Format(CDate(moddat_g_str_FecSis), "dd/mm/yyyy") & " - " & Format(Time, "hh:mm:ss") & ")"
...
Private Sub fs_EvaCre()
   ...
   If Not (g_rst_Princi.BOF And g_rst_Princi.EOF) Then
      ...
      grd_Listad(6).Row = grd_Listad(6).Rows - 1
      grd_Listad(6).Col = 0
      grd_Listad(6).Text = "Total Ingreso Líquido Neto S/. "
