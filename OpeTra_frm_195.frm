...
Begin VB.Form frm_Seg_SolHip_71 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel3 
         ...
         Begin TabDlg.SSTab tab_Seguim 
            ...
            TabPicture(0)   =   "OpeTra_frm_195.frx":000C
            ...
            TabPicture(1)   =   "OpeTra_frm_195.frx":0028
            ...
            TabPicture(2)   =   "OpeTra_frm_195.frx":0044
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "OpeTra_frm_195.frx":0074
            Top             =   60
            Width           =   480
         End
      End
      Begin Threed.SSPanel SSPanel39 
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   10920
            Picture         =   "OpeTra_frm_195.frx":037E
            Style           =   1  'Graphical
            TabIndex        =   43
            ToolTipText     =   "Salir"
            Top             =   30
         ...
         Begin VB.CommandButton cmd_NueObs 
            Height          =   585
            Left            =   30
            Picture         =   "OpeTra_frm_195.frx":07C0
            Style           =   1  'Graphical
            TabIndex        =   42
   ...
   End
End
Attribute VB_Name = "frm_Seg_SolHip_71"
...
Private Sub cmd_NueObs_Click()
   ...
   If moddat_g_int_FlgAct_1 = 2 Then
      ...
      Call fs_Envia_CorreoEle(mps_Sesion, mps_Mensaj, modgen_g_str_Mail_Asunto, modgen_g_str_Mail_Mensaj, moddat_g_str_CodConHip, moddat_g_str_CodEjeSeg, moddat_g_str_NumSol, 42, False, False, False)
...
Dim r_arr_Mtz()      As moddat_g_tpo_DatCom
   ...
   Call modmip_gs_EvaSeg(grd_LisEva, txt_ObsEva)
