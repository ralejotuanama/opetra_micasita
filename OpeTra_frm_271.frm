...
Begin VB.Form frm_Rpt_TraCof_12 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "OpeTra_frm_271.frx":000C
            Top             =   60
            Width           =   480
         End
      End
      Begin Threed.SSPanel SSPanel4 
         ...
         Begin VB.CommandButton cmd_ExpExc 
            Height          =   585
            Left            =   630
            Picture         =   "OpeTra_frm_271.frx":0316
            Style           =   1  'Graphical
            TabIndex        =   9
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   5340
            Picture         =   "OpeTra_frm_271.frx":0620
            Style           =   1  'Graphical
            TabIndex        =   10
            ToolTipText     =   "Salir"
            Top             =   30
         ...
         Begin VB.CommandButton cmd_Imprim 
            Height          =   585
            Left            =   30
            Picture         =   "OpeTra_frm_271.frx":0A62
            Style           =   1  'Graphical
            TabIndex        =   8
   ...
   End
End
Attribute VB_Name = "frm_Rpt_TraCof_12"
...
Private Sub cmd_ExpExc_Click()
   ...
   Call modmip_gs_Exc_EvaSol(62, 3, r_str_CodMod, r_int_TipRes, Format(CDate(ipp_FecIni.Text), "yyyymmdd"), Format(CDate(ipp_FecFin.Text), "yyyymmdd"), r_str_PrySel)
...
Private Sub cmd_Imprim_Click()
   ...
   Call modmip_gs_Rpt_SolEva("CRE_EVAHIP_12.RPT", 3, r_str_CodMod, 62, r_str_PrySel, r_int_TipRes, ipp_FecIni.Text, ipp_FecFin.Text)
