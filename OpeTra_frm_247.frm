...
Begin VB.Form frm_Rpt_PolSeg_06 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin Threed.SSPanel SSPanel7 
            ...
            _ExtentY        =   503
            _StockProps     =   15
            Caption         =   "Reporte de Solicitudes con Aprobación Condicionada en Pólizas de Seguro"
            ForeColor       =   32768
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "MS Sans Serif"
               Size            =   8.25
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "OpeTra_frm_247.frx":000C
            Top             =   60
            Width           =   480
         End
      End
      Begin Threed.SSPanel SSPanel4 
         ...
         Begin VB.CommandButton cmd_Imprim 
            Height          =   585
            Left            =   30
            Picture         =   "OpeTra_frm_247.frx":0316
            Style           =   1  'Graphical
            TabIndex        =   2
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   7110
            Picture         =   "OpeTra_frm_247.frx":0758
            Style           =   1  'Graphical
            TabIndex        =   4
            ToolTipText     =   "Salir"
            Top             =   30
         ...
         Begin VB.CommandButton cmd_ExpExc 
            Height          =   585
            Left            =   630
            Picture         =   "OpeTra_frm_247.frx":0B9A
            Style           =   1  'Graphical
            TabIndex        =   3
   ...
   End
End
Attribute VB_Name = "frm_Rpt_PolSeg_06"
...
Private Sub cmd_ExpExc_Click()
   ...
   If chk_Produc.Value = 0 Then
      Call modmip_gs_Exc_AprCon(61, 1, l_arr_Produc(cmb_Produc.ListIndex + 1).Genera_Codigo)
   Else
      Call modmip_gs_Exc_AprCon(61, 1, "")
   End If
...
Private Sub cmd_Imprim_Click()
   ...
   If chk_Produc.Value = 0 Then
      Call modmip_gs_Rpt_AprCon("CRE_EVAHIP_06.RPT", 1, l_arr_Produc(cmb_Produc.ListIndex + 1).Genera_Codigo, 61, "")
   Else
