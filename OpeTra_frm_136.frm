...
Begin VB.Form frm_Ges_CreHip_01 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel4 
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   7410
            Picture         =   "OpeTra_frm_136.frx":000C
            Style           =   1  'Graphical
            TabIndex        =   3
            ToolTipText     =   "Salir"
            Top             =   390
         ...
         Begin VB.CommandButton cmd_Limpia 
            Height          =   585
            Left            =   6810
            Picture         =   "OpeTra_frm_136.frx":044E
            Style           =   1  'Graphical
            TabIndex        =   2
         ...
         Begin VB.CommandButton cmd_Buscar 
            Height          =   585
            Left            =   6210
            Picture         =   "OpeTra_frm_136.frx":0758
            Style           =   1  'Graphical
            TabIndex        =   1
      ...
      Begin Threed.SSPanel SSPanel3 
         ...
         Begin VB.CommandButton cmd_BusOpe 
            Height          =   585
            Left            =   6810
            Picture         =   "OpeTra_frm_136.frx":0A62
            Style           =   1  'Graphical
            TabIndex        =   6
         ...
         Begin VB.CommandButton cmd_LimOpe 
            Height          =   585
            Left            =   7410
            Picture         =   "OpeTra_frm_136.frx":0D6C
            Style           =   1  'Graphical
            TabIndex        =   7
      ...
      Begin Threed.SSPanel SSPanel2 
         ...
         Begin VB.CommandButton cmd_LimCli 
            Height          =   585
            Left            =   7410
            Picture         =   "OpeTra_frm_136.frx":1076
            Style           =   1  'Graphical
            TabIndex        =   13
         ...
         Begin VB.CommandButton cmd_BusCli 
            Height          =   585
            Left            =   6810
            Picture         =   "OpeTra_frm_136.frx":1380
            Style           =   1  'Graphical
            TabIndex        =   12
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "OpeTra_frm_136.frx":168A
            Top             =   60
            Width           =   480
         End
      End
   ...
   End
End
Attribute VB_Name = "frm_Ges_CreHip_01"
...
Private Sub cmd_Buscar_Click()
   ...
   If moddat_g_int_FlgCre = 1 Then
      frm_Ges_CreHip_02.Show 1
   ElseIf moddat_g_int_FlgCre = 3 Then
      Call cmd_Limpia_Click
      Me.Hide
      frm_Rpt_Cofide_05.gs_IngOper (moddat_g_str_NumOpe)
   Else
