...
Begin VB.Form frm_PolSeg_02 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "OpeTra_frm_027.frx":00D0
            Top             =   60
            Width           =   480
         End
      End
      ...
      Begin Threed.SSPanel SSPanel39 
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   675
            Left            =   10830
            Picture         =   "OpeTra_frm_027.frx":03DA
            Style           =   1  'Graphical
            TabIndex        =   25
            ToolTipText     =   "Salir"
            Top             =   30
         ...
         Begin VB.CommandButton cmd_Aprueb 
            Height          =   675
            Left            =   9450
            Picture         =   "OpeTra_frm_027.frx":081C
            Style           =   1  'Graphical
            TabIndex        =   24
         ...
         Begin VB.CommandButton cmd_Rechaz 
            Height          =   675
            Left            =   10140
            Picture         =   "OpeTra_frm_027.frx":0B26
            Style           =   1  'Graphical
            TabIndex        =   23
      ...
      Begin Threed.SSPanel SSPanel11 
         ...
         Begin VB.CommandButton cmd_GraObs 
            Height          =   675
            Left            =   10140
            Picture         =   "OpeTra_frm_027.frx":0F68
            Style           =   1  'Graphical
            TabIndex        =   31
         ...
         Begin VB.CommandButton cmd_CanObs 
            Height          =   675
            Left            =   10830
            Picture         =   "OpeTra_frm_027.frx":13AA
            Style           =   1  'Graphical
            TabIndex        =   30
         ...
         Begin VB.CommandButton cmd_NueObs 
            Height          =   675
            Left            =   9450
            Picture         =   "OpeTra_frm_027.frx":16B4
            Style           =   1  'Graphical
            TabIndex        =   29
      ...
      Begin Threed.SSPanel SSPanel4 
         ...
         Begin VB.CommandButton cmd_Evalua 
            Height          =   675
            Left            =   10830
            Picture         =   "OpeTra_frm_027.frx":1AFE
            Style           =   1  'Graphical
            TabIndex        =   40
            ToolTipText     =   "Registrar Pólizas de Seguros"
            Top             =   30
            Width           =   675
         End
   ...
   End
End
Attribute VB_Name = "frm_PolSeg_02"
...
Private Sub cmd_Aprueb_Click()
   ...
   If moddat_g_int_FlgAct = 2 Then
      ...
      modgen_g_str_Mail_Asunto = "APROBACION EN TRAMITES DE POLIZAS DE SEGURO (" & Format(CDate(moddat_g_str_FecSis), "dd/mm/yyyy") & " - " & Format(Time, "hh:mm:ss") & ")"
...
Private Sub cmd_GraObs_Click()
   ...
   If Not moddat_gf_Inserta_SegDet(moddat_g_str_NumSol, 61, 21, CStr(grd_LisObs.Rows + 1), txt_Observ.Text, 1, 0) Then
      Exit Sub
   End If
   ...
   'Enviando Correo Electrónico
   modgen_g_str_Mail_Asunto = "OBSERVACION EN TRANITES DE POLIZAS DE SEGUROS (" & Format(CDate(moddat_g_str_FecSis), "dd/mm/yyyy") & " - " & Format(Time, "hh:mm:ss") & ")"
...
Private Sub cmd_Rechaz_Click()
   ...
   If moddat_g_int_MotRec > 0 Then
      ...
      modgen_g_str_Mail_Asunto = "RECHAZO EN TRAMITES DE POLIZAS DE SEGUROS (" & Format(CDate(moddat_g_str_FecSis), "dd/mm/yyyy") & " - " & Format(Time, "hh:mm:ss") & ")"
...
Private Sub Form_Load()
   ...
   pnl_IngIns.Caption = moddat_gf_FecIng_Ins(moddat_g_str_NumSol, 61)
