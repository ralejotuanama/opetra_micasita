...
Begin VB.Form frm_Rpt_EvaSeg_13 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "OpeTra_frm_273.frx":000C
            Top             =   60
            Width           =   480
         End
      End
      Begin Threed.SSPanel SSPanel4 
         ...
         Begin VB.CommandButton cmd_Imprim 
            Height          =   585
            Left            =   30
            Picture         =   "OpeTra_frm_273.frx":0316
            Style           =   1  'Graphical
            TabIndex        =   6
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   7110
            Picture         =   "OpeTra_frm_273.frx":0758
            Style           =   1  'Graphical
            TabIndex        =   8
            ToolTipText     =   "Salir"
            Top             =   30
         ...
         Begin VB.CommandButton cmd_ExpExc 
            Height          =   585
            Left            =   630
            Picture         =   "OpeTra_frm_273.frx":0B9A
            Style           =   1  'Graphical
            TabIndex        =   7
   ...
   End
End
Attribute VB_Name = "frm_Rpt_EvaSeg_13"
...
Private Sub cmd_ExpExc_Click()
   ...
   Call modmip_gs_Exc_EvaSol(42, 4, r_str_TipEva, r_int_TipRes, Format(CDate(ipp_FecIni.Text), "yyyymmdd"), Format(CDate(ipp_FecFin.Text), "yyyymmdd"), "")
...
Private Sub cmd_Imprim_Click()
   ...
   Call modmip_gs_Rpt_SolEva("CRE_EVAHIP_13.RPT", 4, r_str_TipEva, 42, "", r_int_TipRes, ipp_FecIni.Text, ipp_FecFin.Text)
