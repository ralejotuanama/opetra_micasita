...
Begin VB.Form frm_EvaSeg_11 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel4 
         ...
         Begin TabDlg.SSTab tab_Seguim 
            ...
            TabPicture(0)   =   "OpeTra_frm_096.frx":000C
            ...
            TabPicture(1)   =   "OpeTra_frm_096.frx":0028
            ...
            TabPicture(2)   =   "OpeTra_frm_096.frx":0044
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "OpeTra_frm_096.frx":0074
            Top             =   60
            Width           =   480
         End
      End
      Begin Threed.SSPanel SSPanel36 
         ...
         Begin VB.CommandButton cmd_Evalua 
            Height          =   585
            Left            =   30
            Picture         =   "OpeTra_frm_096.frx":037E
            Style           =   1  'Graphical
            TabIndex        =   62
         ...
         Begin VB.CommandButton cmd_NueObs 
            Height          =   585
            Left            =   630
            Picture         =   "OpeTra_frm_096.frx":0688
            Style           =   1  'Graphical
            TabIndex        =   46
         ...
         Begin VB.CommandButton cmd_Excepc 
            Height          =   585
            Left            =   1230
            Picture         =   "OpeTra_frm_096.frx":0ACA
            Style           =   1  'Graphical
            TabIndex        =   45
         ...
         Begin VB.CommandButton cmd_AprCon 
            Height          =   585
            Left            =   1830
            Picture         =   "OpeTra_frm_096.frx":0DD4
            Style           =   1  'Graphical
            TabIndex        =   44
         ...
         Begin VB.CommandButton cmd_Rechaz 
            Height          =   585
            Left            =   3030
            Picture         =   "OpeTra_frm_096.frx":10DE
            Style           =   1  'Graphical
            TabIndex        =   43
         ...
         Begin VB.CommandButton cmd_Aprueb 
            Height          =   585
            Left            =   2430
            Picture         =   "OpeTra_frm_096.frx":1520
            Style           =   1  'Graphical
            TabIndex        =   42
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   10920
            Picture         =   "OpeTra_frm_096.frx":182A
            Style           =   1  'Graphical
            TabIndex        =   41
            ToolTipText     =   "Salir"
            Top             =   30
   ...
   End
End
Attribute VB_Name = "frm_EvaSeg_11"
...
Private Sub cmd_Excepc_Click()
   ...
   If moddat_g_int_FlgAct_1 = 2 Then
      ...
      'Enviando Correo Electrónico
      modgen_g_str_Mail_Asunto = "EVALUACION DE SEGUROS - EXCEPCION (" & Format(CDate(moddat_g_str_FecSis), "dd/mm/yyyy") & " - " & Format(Time, "hh:mm:ss") & ")"
...
Private Sub cmd_Rechaz_Click()
   ...
   If moddat_g_int_MotRec > 0 Then
      ...
      modgen_g_str_Mail_Asunto = "EVALUACION DE SEGUROS - RECHAZO (" & Format(CDate(moddat_g_str_FecSis), "dd/mm/yyyy") & " - " & Format(Time, "hh:mm:ss") & ")"
