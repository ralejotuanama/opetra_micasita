...
Begin VB.Form frm_Hip_RecAdm_02 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel4 
         ...
         Begin TabDlg.SSTab tab_Seguim 
            ...
            TabPicture(0)   =   "OpeTra_frm_114.frx":000C
            ...
            Tab(0).Control(11)=   "txt_Observ"
            Tab(0).ControlCount=   12
            TabCaption(1)   =   "Excepciones Aplicadas"
            TabPicture(1)   =   "OpeTra_frm_114.frx":0028
            ...
            TabPicture(2)   =   "OpeTra_frm_114.frx":0044
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "OpeTra_frm_114.frx":0074
            Top             =   60
            Width           =   480
         End
      End
      Begin Threed.SSPanel SSPanel36 
         ...
         Begin VB.CommandButton cmd_Rechaz 
            Height          =   585
            Left            =   30
            Picture         =   "OpeTra_frm_114.frx":037E
            Style           =   1  'Graphical
            TabIndex        =   2
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   10920
            Picture         =   "OpeTra_frm_114.frx":07C0
            Style           =   1  'Graphical
            TabIndex        =   3
            ToolTipText     =   "Salir"
            Top             =   30
   ...
   End
End
Attribute VB_Name = "frm_Hip_RecAdm_02"
...
Private Sub cmd_Rechaz_Click()
   If cmb_MotRec.ListIndex = -1 Then
      ...
      Exit Sub
   End If
   If Len(Trim(txt_ObsRec.Text)) = 0 Then
      MsgBox "Debe ingresar las Observaciones del Rechazo.", vbExclamation, modgen_g_str_NomPlt
      Call gs_SetFocus(txt_ObsRec)
      Exit Sub
   End If
   ...
   'Generando Ocurrencia en Detalle de Seguimientos
   If Not moddat_gf_Inserta_SegDet(moddat_g_str_NumSol, 91, 14, 0, "", 0, cmb_MotRec.ItemData(cmb_MotRec.ListIndex)) Then
      Exit Sub
   End If
      
   'Creando Registro en Cabecera de Seguimiento
   If Not moddat_gf_Inserta_Seguim(moddat_g_str_NumSol, 91) Then
      Exit Sub
   End If
      
   'Modificando Registro en Cabecera de Seguimiento
   If Not moddat_gf_Modifica_Seguim(moddat_g_str_NumSol, 91, 0, 2, 1) Then
      Exit Sub
   End If
      
   'Registrando Información del Rechazo
   moddat_g_int_FlgGOK = False
   moddat_g_int_CntErr = 0
   
   Do While moddat_g_int_FlgGOK = False
      g_str_Parame = "USP_INSERTA_TRA_RECADM ("
      g_str_Parame = g_str_Parame & "'" & moddat_g_str_NumSol & "', "
      g_str_Parame = g_str_Parame & CStr(cmb_MotRec.ItemData(cmb_MotRec.ListIndex)) & ", "
      g_str_Parame = g_str_Parame & "'" & txt_ObsRec.Text & "', "
      ...
      If moddat_g_int_CntErr = 6 Then
         If MsgBox("No se pudo completar el procedimiento USP_INSERTA_TRA_RECADM. ¿Desea seguir intentando?", vbQuestion + vbYesNo + vbDefaultButton2, modgen_g_con_PltPar) <> vbYes Then
            Exit Sub
         Else
            moddat_g_int_CntErr = 0
         End If
   ...
   modgen_g_str_Mail_Asunto = "RECHAZO ADMINISTRATIVO (" & Format(CDate(moddat_g_str_FecSis), "dd/mm/yyyy") & " - " & Format(Time, "hh:mm:ss") & ")"
   ...
   modgen_g_str_Mail_Mensaj = modgen_g_str_Mail_Mensaj & Chr(13)
   modgen_g_str_Mail_Mensaj = modgen_g_str_Mail_Mensaj & txt_ObsRec.Text
   ...
   MsgBox "La solicitud fue rechazada con éxito.", vbInformation, modgen_g_str_NomPlt
   Unload Me
End Sub
...
Private Sub fs_Inicia()
   ...
   'Motivos de Rechazo
   Call moddat_gs_Carga_MotRec(cmb_MotRec, 91)
...
Private Sub fs_Buscar_LisOcu()
   ...
   g_str_Parame = g_str_Parame & "SEGDET_NUMSOL = '" & moddat_g_str_NumSol & "' "
   'g_str_Parame = g_str_Parame & "ORDER BY SEGDET_CODINS DESC, SEGFECCRE DESC, SEGHORCRE DESC "
...
Private Sub txt_ObsRec_GotFocus()
   Call gs_SelecTodo(txt_ObsRec)
End Sub
