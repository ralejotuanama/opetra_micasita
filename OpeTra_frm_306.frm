...
Begin VB.Form frm_Tra_Desemb_02 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel2 
         ...
         Begin TabDlg.SSTab SSTab1 
            ...
            TabPicture(0)   =   "OpeTra_frm_306.frx":0010
            Tab(0).ControlEnabled=   -1  'True
            Tab(0).Control(0)=   "grd_Listad(0)"
            Tab(0).Control(0).Enabled=   0   'False
            Tab(0).ControlCount=   1
            TabCaption(1)   =   "Cónyuge"
            TabPicture(1)   =   "OpeTra_frm_306.frx":002C
            Tab(1).ControlEnabled=   0   'False
            Tab(1).Control(0)=   "grd_Listad(9)"
            Tab(1).ControlCount=   1
            TabCaption(2)   =   "Apoderado"
            TabPicture(2)   =   "OpeTra_frm_306.frx":0048
            Tab(2).ControlEnabled=   0   'False
            Tab(2).Control(0)=   "grd_Listad(8)"
            Tab(2).ControlCount=   1
            TabCaption(3)   =   "Inmueble"
            TabPicture(3)   =   "OpeTra_frm_306.frx":0064
            Tab(3).ControlEnabled=   0   'False
            Tab(3).Control(0)=   "grd_Listad(1)"
            Tab(3).ControlCount=   1
            TabCaption(4)   =   "Crédito"
            TabPicture(4)   =   "OpeTra_frm_306.frx":0080
            Tab(4).ControlEnabled=   0   'False
            Tab(4).Control(0)=   "grd_Listad(2)"
            Tab(4).ControlCount=   1
            TabCaption(5)   =   "Evaluación Crediticia"
            TabPicture(5)   =   "OpeTra_frm_306.frx":009C
            Tab(5).ControlEnabled=   0   'False
            Tab(5).Control(0)=   "grd_Listad(3)"
            Tab(5).ControlCount=   1
            TabCaption(6)   =   "Tasación"
            TabPicture(6)   =   "OpeTra_frm_306.frx":00B8
            Tab(6).ControlEnabled=   0   'False
            Tab(6).Control(0)=   "grd_Listad(4)"
            Tab(6).ControlCount=   1
            TabCaption(7)   =   "Seguros"
            TabPicture(7)   =   "OpeTra_frm_306.frx":00D4
            Tab(7).ControlEnabled=   0   'False
            Tab(7).Control(0)=   "Label5"
            Tab(7).Control(1)=   "Label4"
            Tab(7).Control(2)=   "grd_Listad(5)"
            Tab(7).Control(3)=   "txt_ObsSeg"
            Tab(7).ControlCount=   4
            TabCaption(8)   =   "Informe Legal"
            TabPicture(8)   =   "OpeTra_frm_306.frx":00F0
            Tab(8).ControlEnabled=   0   'False
            Tab(8).Control(0)=   "txt_InfLeg"
            Tab(8).ControlCount=   1
            TabCaption(9)   =   "Ev. Legal"
            TabPicture(9)   =   "OpeTra_frm_306.frx":010C
            Tab(9).ControlEnabled=   0   'False
            Tab(9).Control(0)=   "Label2"
            Tab(9).Control(1)=   "Label3"
            Tab(9).Control(2)=   "grd_Listad(6)"
            Tab(9).Control(3)=   "txt_ComCre"
            Tab(9).ControlCount=   4
            TabCaption(10)  =   "Mivivienda/Cofide"
            TabPicture(10)  =   "OpeTra_frm_306.frx":0128
            Tab(10).ControlEnabled=   0   'False
            Tab(10).Control(0)=   "Label6"
            Tab(10).Control(1)=   "Label7"
            Tab(10).Control(2)=   "grd_Listad(7)"
            Tab(10).Control(3)=   "txt_ObsMVi"
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "OpeTra_frm_306.frx":0154
            Top             =   60
            Width           =   480
         End
      End
      ...
      Begin Threed.SSPanel SSPanel39 
         ...
         Begin VB.CommandButton cmd_DiaPag 
            Height          =   585
            Left            =   4230
            Picture         =   "OpeTra_frm_306.frx":045E
            Style           =   1  'Graphical
            TabIndex        =   28
         ...
         Begin VB.CommandButton cmd_CerPar 
            Height          =   585
            Left            =   3630
            Picture         =   "OpeTra_frm_306.frx":0768
            Style           =   1  'Graphical
            TabIndex        =   27
         ...
         Begin VB.CommandButton cmd_CarFia 
            Height          =   585
            Left            =   3030
            Picture         =   "OpeTra_frm_306.frx":0A72
            Style           =   1  'Graphical
            TabIndex        =   26
         ...
         Begin VB.CommandButton cmd_ChqGer 
            Height          =   585
            Left            =   2430
            Picture         =   "OpeTra_frm_306.frx":0D7C
            Style           =   1  'Graphical
            TabIndex        =   25
         ...
         Begin VB.CommandButton cmd_PolSeg 
            Height          =   585
            Left            =   1830
            Picture         =   "OpeTra_frm_306.frx":1086
            Style           =   1  'Graphical
            TabIndex        =   24
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   10920
            Picture         =   "OpeTra_frm_306.frx":1390
            Style           =   1  'Graphical
            TabIndex        =   23
            ToolTipText     =   "Salir"
            Top             =   30
         ...
         Begin VB.CommandButton cmd_Desemb 
            Height          =   585
            Left            =   30
            Picture         =   "OpeTra_frm_306.frx":17D2
            Style           =   1  'Graphical
            TabIndex        =   22
         ...
         Begin VB.CommandButton cmd_Imprim 
            Height          =   585
            Left            =   630
            Picture         =   "OpeTra_frm_306.frx":1ADC
            Style           =   1  'Graphical
            TabIndex        =   21
         ...
         Begin VB.CommandButton cmd_Export 
            Height          =   585
            Left            =   1230
            Picture         =   "OpeTra_frm_306.frx":1F1E
            Style           =   1  'Graphical
            TabIndex        =   20
         ...
         Begin VB.CommandButton cmd_EnvLeg 
            Height          =   585
            Left            =   4830
            Picture         =   "OpeTra_frm_306.frx":2228
            Style           =   1  'Graphical
            TabIndex        =   19
   ...
   End
End
Attribute VB_Name = "frm_Tra_Desemb_02"
...
Private Sub cmd_EnvLeg_Click()
   ...
   g_str_Parame = "SELECT * FROM TRA_SEGDES WHERE "
   g_str_Parame = g_str_Parame & "SEGDES_NUMSOL = '" & moddat_g_str_NumSol & "' "
...
Private Sub Form_Load()
   ...
   Call modmip_gs_DatCli(moddat_g_int_CygTDo, moddat_g_str_CygNDo, grd_Listad(9), 1)      'Buscar Información del Cónyuge
   
   Call modmip_gs_DatApo(moddat_g_int_TipDoc, moddat_g_str_NumDoc, grd_Listad(8))         'Buscar Información del Apoderado
   ...
   'Call fs_DatCre
   Call fs_EvaCre
   Call modmip_gs_EvaTas(grd_Listad(4))                                                   ' Tasación    Call fs_DatTas
   Call modmip_gs_EvaSeg(grd_Listad(5))                                                   ' Seguro
   Call fs_DatSeg
   Call modmip_gs_Buscar_EvaLeg(grd_Listad(6), grd_Listad(6), txt_InfLeg, txt_ComCre)     ' Legal
   Call fs_DatLeg
...
Private Sub fs_Inicia()
   ...
   'Datos del Conyuge
   grd_Listad(9).ColWidth(0) = 3000:   grd_Listad(9).ColAlignment(0) = flexAlignLeftCenter
   grd_Listad(9).ColWidth(1) = 7940:   grd_Listad(9).ColAlignment(1) = flexAlignLeftCenter
...
Private Sub fs_DatSeg()
   ...
   g_str_Parame = "SELECT POLIZA_NUMVIV FROM TRA_POLIZA WHERE "
...
Private Sub fs_LiqDes()
   ...
   g_str_Parame = ""
   g_str_Parame = g_str_Parame & "DELETE FROM RPT_FORDES WHERE "
   g_str_Parame = g_str_Parame & "FORDES_NUMOPE = '" & moddat_g_str_NumOpe & "' "
...
Private Sub fs_HojRes()
   ...
   ElseIf InStr(moddat_g_str_Agr1FMV, moddat_g_str_CodPrd) > 0 Or InStr(moddat_g_str_Agr2FMV, moddat_g_str_CodPrd) > 0 Then 'moddat_g_str_CodPrd = "007" Or moddat_g_str_CodPrd = "009" Or moddat_g_str_CodPrd = "010" Or moddat_g_str_CodPrd = "013" Or moddat_g_str_CodPrd = "014" Or moddat_g_str_CodPrd = "015" Or moddat_g_str_CodPrd = "016" Or moddat_g_str_CodPrd = "017" Or moddat_g_str_CodPrd = "018" Or moddat_g_str_CodPrd = "019" Or moddat_g_str_CodPrd = "020" Or moddat_g_str_CodPrd = "021" Or moddat_g_str_CodPrd = "022" Or moddat_g_str_CodPrd = "023" Then
...
Private Sub fs_ComPag()
   ...
   g_str_Parame = g_str_Parame & "CAJMOV_NUMOPE = '" & moddat_g_str_NumOpe & "' "
