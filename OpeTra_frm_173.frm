...
Begin VB.Form frm_MntCli_63 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel8 
         ...
         Begin VB.CommandButton cmd_Buscar 
            Height          =   585
            Left            =   9780
            Picture         =   "OpeTra_frm_173.frx":000C
            Style           =   1  'Graphical
            TabIndex        =   2
         ...
         Begin VB.CommandButton cmd_Limpia 
            Height          =   585
            Left            =   10380
            Picture         =   "OpeTra_frm_173.frx":0316
            Style           =   1  'Graphical
            TabIndex        =   3
         ...
         Begin VB.CommandButton cmd_Editar 
            Height          =   585
            Left            =   10980
            Picture         =   "OpeTra_frm_173.frx":0620
            Style           =   1  'Graphical
            TabIndex        =   4
            Top             =   60
            Width           =   585
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin Threed.SSPanel SSPanel7 
            ...
            _ExtentY        =   450
            _StockProps     =   15
            Caption         =   "Actividades Económicas - Dependiente"
            ForeColor       =   32768
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "MS Sans Serif"
               Size            =   8.25
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "OpeTra_frm_173.frx":092A
            Top             =   60
            Width           =   480
         End
      End
      ...
      Begin Threed.SSPanel SSPanel9 
         ...
         Begin VB.CommandButton cmd_Grabar 
            Height          =   585
            Left            =   30
            Picture         =   "OpeTra_frm_173.frx":0C34
            Style           =   1  'Graphical
            TabIndex        =   10
            Top             =   30
            Width           =   585
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   10980
            Picture         =   "OpeTra_frm_173.frx":1076
            Style           =   1  'Graphical
            TabIndex        =   11
            Top             =   30
            Width           =   585
   ...
   End
End
Attribute VB_Name = "frm_MntCli_63"
...
Private Sub cmd_Grabar_Click()
   ...
   g_str_Parame = g_str_Parame & "11, "                                                      'Código Actividad Económica (Dependiente)
   
   'Dependiente
   g_str_Parame = g_str_Parame & CStr(cmb_TipDoc.ItemData(cmb_TipDoc.ListIndex)) & ", "      'Tipo DOI Empleador
   g_str_Parame = g_str_Parame & "'" & txt_NumDoc.Text & "', "                               'Número DOI Empleador
   g_str_Parame = g_str_Parame & "'" & l_str_RazSoc & "', "                                  'Razón Social
   g_str_Parame = g_str_Parame & "'" & l_str_NomCom & "', "                                  'Nombre Comercial
   g_str_Parame = g_str_Parame & "1, "                                                       'Tipo de Oficina
   g_str_Parame = g_str_Parame & "1, "                                                       'Situación Trabajador
   ...
   g_str_Parame = g_str_Parame & CStr(l_int_CodCiu) & ", "                                'Código CIIU
   ...
   g_str_Parame = g_str_Parame & "'999999', "                                             'Código de Cargo
   ...
   g_str_Parame = g_str_Parame & "'" & l_str_Direcc & "', "                               'Dirección
   g_str_Parame = g_str_Parame & "'" & l_str_PrvEst & "', "                               'Provincia / Estado
   g_str_Parame = g_str_Parame & "'" & l_str_CodPos & "', "                               'Código Postal
...
Private Sub fs_BusEmp()
   ...
   l_str_Direcc = Trim(r_rst_Princi!DATGEN_EXTDIR & "")
   l_str_PrvEst = Trim(r_rst_Princi!DATGEN_EXTCIU & "")
   l_str_CodPos = Trim(r_rst_Princi!DATGEN_EXTCPO & "")
