...
Begin VB.Form frm_Seg_SolHip_54 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel2 
         ...
         Begin VB.CommandButton cmd_Limpiar 
            Height          =   585
            Left            =   630
            Picture         =   "OpeTra_frm_183.frx":000C
            Style           =   1  'Graphical
            TabIndex        =   80
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   10830
            Picture         =   "OpeTra_frm_183.frx":0316
            Style           =   1  'Graphical
            TabIndex        =   75
         ...
         Begin VB.CommandButton cmd_Grabar 
            Height          =   585
            Left            =   30
            Picture         =   "OpeTra_frm_183.frx":0758
            Style           =   1  'Graphical
            TabIndex        =   74
      ...
      Begin Threed.SSPanel SSPanel3 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "OpeTra_frm_183.frx":0B9A
            Top             =   60
            Width           =   480
         End
      End
   ...
   End
End
Attribute VB_Name = "frm_Seg_SolHip_54"
...
Private Sub fs_Activa(ByVal p_Habilita As Integer)
   ...
   cmb_FlgEst.Enabled = p_Habilita
   If cmb_FlgEst.Enabled = False Then
      txt_Estaci.Enabled = False
   End If
End Sub
...
Dim r_bol_Estado As Boolean
   ...
   End If
    ...
    'solo origen instanci documentos del inmueble
   If moddat_g_int_FlgAct_2 = 1 Then
      If Len(Trim(txt_IntDpt.Text)) = 0 Then
         MsgBox "Debe ingresar el Int/Dpto.", vbExclamation, modgen_g_str_NomPlt
         Call gs_SetFocus(txt_IntDpt)
         Exit Sub
      End If
      
'      If Len(Trim(txt_Estaci.Text)) = 0 Then
'         MsgBox "Debe ingresar el estacionamiento.", vbExclamation, modgen_g_str_NomPlt
'         Call gs_SetFocus(txt_Estaci)
'         Exit Sub
'      End If
   End If
   ...
   Do While moddat_g_int_FlgGOK = False
      ...
      g_str_Parame = g_str_Parame & cmb_FlgEst.ItemData(cmb_FlgEst.ListIndex) & ", "
      ...
      '*********bien terminado(1), bien futuro individual(2), bien futuro proyecto hipotecario(3)*********
      ...
      If CInt(l_arr_Modali(cmb_Modali.ListIndex + 1).Genera_Codigo) = 1 Then ' Or CInt(l_arr_Modali(cmb_Modali.ListIndex + 1).Genera_Codigo) = 4 Then
         ...
         If (cmb_TipDoc_Pro.ListIndex = -1) Then
             If (grd_Listad_Pro.Rows > 0) Then
                 If (cmb_Pryvin.ListIndex > -1) Then  'Vinculado
                 ...
                 ElseIf (cmb_PryNVi.ListIndex > -1) Then 'No Vinculado
      ...
      Else
         If (grd_Listad_Pro.Rows > 0) Then
             If (cmb_Pryvin.ListIndex > -1) Then  'Vinculado
                 g_str_Parame = g_str_Parame & CStr(l_arr_PryVin(cmb_Pryvin.ListIndex + 1).Genera_VenTDo) & ", "
                 g_str_Parame = g_str_Parame & "'" & l_arr_PryVin(cmb_Pryvin.ListIndex + 1).Genera_VenNDo & "', "
             ElseIf (cmb_PryNVi.ListIndex > -1) Then 'No Vinculado
                 g_str_Parame = g_str_Parame & CStr(l_arr_PryNVi(cmb_PryNVi.ListIndex + 1).Genera_VenTDo) & ", "
                 g_str_Parame = g_str_Parame & "'" & l_arr_PryNVi(cmb_PryNVi.ListIndex + 1).Genera_VenNDo & "', "
             End If
         Else
...
Private Sub Form_Load()
   ...
   If moddat_g_int_FlgGrb = 2 Then
      ...
      If Not (g_rst_Princi.BOF And g_rst_Princi.EOF) Then
         ...
         Call gs_BuscarCombo_Item(cmb_FlgEst, g_rst_Princi!solinm_flgest)
         ...
         If CInt(g_rst_Princi!SOLINM_CODMOD) = 1 Then
            If (Not IsNull(g_rst_Princi!SOLINM_TIPDOC_PRO) = True And Trim(g_rst_Princi!SOLINM_NUMDOC_PRO & "") <> "" _
                And Trim(g_rst_Princi!SOLINM_RAZSOC_PRO & "") <> "") Then
                'Bien Terminado
