...
Begin VB.Form frm_Ges_CreHip_10 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel2 
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   6540
            Picture         =   "OpeTra_frm_145.frx":000C
            Style           =   1  'Graphical
            TabIndex        =   3
            Top             =   30
            Width           =   585
         ...
         Begin VB.CommandButton cmd_Imprim 
            Height          =   585
            Left            =   30
            Picture         =   "OpeTra_frm_145.frx":044E
            Style           =   1  'Graphical
            TabIndex        =   2
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "OpeTra_frm_145.frx":0890
            Top             =   60
            Width           =   480
         End
      End
   ...
   End
End
Attribute VB_Name = "frm_Ges_CreHip_10"
...
Private Sub cmd_Imprim_Click()
   ...
   If MsgBox("¿Está seguro de imprimir el Estado de Cuenta?", vbQuestion + vbYesNo + vbDefaultButton2, modgen_g_str_NomPlt) <> vbYes Then
      Exit Sub
   End If
   ...
   g_str_Parame = g_str_Parame & "ECTACB_NOMRPT = 'OPE_ESTCTA_01.RPT' "
   ...
   g_str_Parame = g_str_Parame & "ECTADT_NOMRPT = 'OPE_ESTCTA_01.RPT' "
   
   If Not gf_EjecutaSQL(g_str_Parame, g_rst_Princi, 2) Then
       Exit Sub
   End If
   
   Call opecaj_gs_EstCta(moddat_g_str_NumOpe, Format(CDate(ipp_FecIni.Text), "yyyymmdd"), Format(CDate(ipp_FecFin.Text), "yyyymmdd"))
   ...
   crp_Imprim.ReportFileName = g_str_RutRpt & "\" & "OPE_ESTCTA_01.RPT"
        
   crp_Imprim.SelectionFormula = "{RPT_ECTADT.ECTADT_NOMRPT} = 'OPE_ESTCTA_01.RPT' AND "
...
Private Sub Form_Load()
   ...
   ipp_FecIni.Text = moddat_g_str_FecApr
