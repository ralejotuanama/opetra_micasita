...
Begin VB.Form frm_TraCof_11 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel4 
         ...
         Begin TabDlg.SSTab tab_Seguim 
            ...
            TabPicture(0)   =   "OpeTra_frm_105.frx":000C
            ...
            TabPicture(1)   =   "OpeTra_frm_105.frx":0028
            ...
            TabPicture(2)   =   "OpeTra_frm_105.frx":0044
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "OpeTra_frm_105.frx":0074
            Top             =   60
            Width           =   480
         End
      End
      Begin Threed.SSPanel SSPanel36 
         ...
         Begin VB.CommandButton cmd_Imprim 
            Height          =   585
            Left            =   1230
            Picture         =   "OpeTra_frm_105.frx":037E
            Style           =   1  'Graphical
            TabIndex        =   64
            Top             =   30
            Width           =   585
         ...
         Begin VB.CommandButton cmd_RecMVi 
            Height          =   585
            Left            =   630
            Picture         =   "OpeTra_frm_105.frx":07C0
            Style           =   1  'Graphical
            TabIndex        =   63
         ...
         Begin VB.CommandButton cmd_EnvMVi 
            Height          =   585
            Left            =   30
            Picture         =   "OpeTra_frm_105.frx":108A
            Style           =   1  'Graphical
            TabIndex        =   62
         ...
         Begin VB.CommandButton cmd_NueObs 
            Height          =   585
            Left            =   1830
            Picture         =   "OpeTra_frm_105.frx":1394
            Style           =   1  'Graphical
            TabIndex        =   46
         ...
         Begin VB.CommandButton cmd_Excepc 
            Height          =   585
            Left            =   2430
            Picture         =   "OpeTra_frm_105.frx":17D6
            Style           =   1  'Graphical
            TabIndex        =   45
         ...
         Begin VB.CommandButton cmd_AprCon 
            Height          =   585
            Left            =   3030
            Picture         =   "OpeTra_frm_105.frx":1AE0
            Style           =   1  'Graphical
            TabIndex        =   44
         ...
         Begin VB.CommandButton cmd_Rechaz 
            Height          =   585
            Left            =   4230
            Picture         =   "OpeTra_frm_105.frx":1DEA
            Style           =   1  'Graphical
            TabIndex        =   43
         ...
         Begin VB.CommandButton cmd_Aprueb 
            Height          =   585
            Left            =   3630
            Picture         =   "OpeTra_frm_105.frx":222C
            Style           =   1  'Graphical
            TabIndex        =   42
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   10920
            Picture         =   "OpeTra_frm_105.frx":2536
            Style           =   1  'Graphical
            TabIndex        =   41
            ToolTipText     =   "Salir"
            Top             =   30
   ...
   End
End
Attribute VB_Name = "frm_TraCof_11"
...
Private Sub cmd_AprCon_Click()
   ...
   Else
      ...
      modgen_g_str_Mail_Asunto = "TRAMITES COFIDE Y EMISION DE POLIZAS DE SEGURO - APROBACION CONDICIONADA (" & Format(CDate(moddat_g_str_FecSis), "dd/mm/yyyy") & " - " & Format(Time, "hh:mm:ss") & ")"
...
Private Sub cmd_Aprueb_Click()
   ...
   Else
      ...
      'Enviando Correo Electrónico
      modgen_g_str_Mail_Asunto = "TRAMITES COFIDE Y EMISION DE POLIZAS DE SEGURO - APROBACION (" & Format(CDate(moddat_g_str_FecSis), "dd/mm/yyyy") & " - " & Format(Time, "hh:mm:ss") & ")"
...
Private Sub cmd_Excepc_Click()
   ...
   If moddat_g_int_FlgAct_1 = 2 Then
      ...
      'Enviando Correo Electrónico
      modgen_g_str_Mail_Asunto = "TRAMITES COFIDE - EXCEPCION (" & Format(CDate(moddat_g_str_FecSis), "dd/mm/yyyy") & " - " & Format(Time, "hh:mm:ss") & ")"
...
Private Sub cmd_NueObs_Click()
   ...
   If moddat_g_int_FlgAct_1 = 2 Then
      ...
      If moddat_g_int_TipObs = 1 Then
         ...
         modgen_g_str_Mail_Asunto = "TRAMITES COFIDE - OBSERVACION (Cliente: " & CStr(moddat_g_int_TipDoc) & "-" & moddat_g_str_NumDoc & " - " & moddat_g_str_NomCli & ")"
      ...
      Else
         ...
         modgen_g_str_Mail_Asunto = "TRAMITES COFIDE - COMENTARIO (Cliente: " & CStr(moddat_g_int_TipDoc) & "-" & moddat_g_str_NumDoc & " - " & moddat_g_str_NomCli & ")"
      End If
...
Private Sub cmd_Rechaz_Click()
   ...
   If moddat_g_int_MotRec > 0 Then
      ...
      modgen_g_str_Mail_Asunto = "TRAMITES COFIDE - RECHAZO (" & Format(CDate(moddat_g_str_FecSis), "dd/mm/yyyy") & " - " & Format(Time, "hh:mm:ss") & ")"
...
Private Sub cmd_RecMVi_Click()
   ...
   If moddat_g_str_CodPrd = "004" Or moddat_g_str_CodPrd = "007" Or moddat_g_str_CodPrd = "009" Or moddat_g_str_CodPrd = "010" Then
      frm_TraCof_14.Show 1
   ElseIf moddat_g_str_CodPrd = "003" Then
      frm_TraCof_13.Show 1
   End If
...
Private Sub fs_ActEco_Dep(ByVal p_Indice As Integer, ByVal p_ColTxt)
   ...
   Else
      ...
      'Modificado 19/08/2010 DSECLEN
      '******************************************************************
      
         If Trim(g_rst_Genera!DATGEN_PAIRES & "") <> "004028" Then
            grd_Listad(p_Indice).Rows = grd_Listad(p_Indice).Rows + 1
            grd_Listad(p_Indice).Row = grd_Listad(p_Indice).Rows - 1
            grd_Listad(p_Indice).Col = 0
            grd_Listad(p_Indice).CellForeColor = p_ColTxt
            ...
            grd_Listad(p_Indice).Col = 1
            grd_Listad(p_Indice).CellForeColor = p_ColTxt
            grd_Listad(p_Indice).Text = Trim(g_rst_Genera!DATGEN_EXTDIR & "")
   
            grd_Listad(p_Indice).Rows = grd_Listad(p_Indice).Rows + 1
            grd_Listad(p_Indice).Row = grd_Listad(p_Indice).Rows - 1
            grd_Listad(p_Indice).Col = 0
            grd_Listad(p_Indice).CellForeColor = p_ColTxt
            grd_Listad(p_Indice).Text = "Ciudad"
      
            grd_Listad(p_Indice).Col = 1
            grd_Listad(p_Indice).CellForeColor = p_ColTxt
            grd_Listad(p_Indice).Text = modmip_gf_Consulta_CiuExt(Format(g_rst_Genera!DATGEN_PAIRES, "000000"), Trim(g_rst_Genera!DATGEN_EXTCIU))
   
            grd_Listad(p_Indice).Rows = grd_Listad(p_Indice).Rows + 1
            grd_Listad(p_Indice).Row = grd_Listad(p_Indice).Rows - 1
            grd_Listad(p_Indice).Col = 0
            grd_Listad(p_Indice).CellForeColor = p_ColTxt
            grd_Listad(p_Indice).Text = "Código Postal"
   
            grd_Listad(p_Indice).Col = 1
            grd_Listad(p_Indice).CellForeColor = p_ColTxt
            grd_Listad(p_Indice).Text = Trim(g_rst_Genera!DATGEN_EXTCPO & "")
