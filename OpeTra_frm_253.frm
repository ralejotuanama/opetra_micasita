...
Begin VB.Form frm_Rpt_EvaSeg_08 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin Threed.SSPanel SSPanel7 
            ...
            _ExtentY        =   503
            _StockProps     =   15
            Caption         =   "Reporte de Solicitudes con Excepción en Evaluación de Seguros"
            ForeColor       =   32768
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "MS Sans Serif"
               Size            =   8.25
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "OpeTra_frm_253.frx":000C
            Top             =   60
            Width           =   480
         End
      End
      Begin Threed.SSPanel SSPanel4 
         ...
         Begin VB.CommandButton cmd_ExpExc 
            Height          =   585
            Left            =   630
            Picture         =   "OpeTra_frm_253.frx":0316
            Style           =   1  'Graphical
            TabIndex        =   5
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   7110
            Picture         =   "OpeTra_frm_253.frx":0620
            Style           =   1  'Graphical
            TabIndex        =   6
            ToolTipText     =   "Salir"
            Top             =   30
         ...
         Begin VB.CommandButton cmd_Imprim 
            Height          =   585
            Left            =   30
            Picture         =   "OpeTra_frm_253.frx":0A62
            Style           =   1  'Graphical
            TabIndex        =   4
   ...
   End
End
Attribute VB_Name = "frm_Rpt_EvaSeg_08"
...
Private Sub cmd_ExpExc_Click()
   ...
   If chk_Produc.Value = 0 Then
      Call modmip_gs_Exc_ExcEva(42, 1, l_arr_Produc(cmb_Produc.ListIndex + 1).Genera_Codigo, Format(CDate(ipp_FecIni.Text), "yyyymmdd"), Format(CDate(ipp_FecFin.Text), "yyyymmdd"))
   Else
      Call modmip_gs_Exc_ExcEva(42, 1, "", Format(CDate(ipp_FecIni.Text), "yyyymmdd"), Format(CDate(ipp_FecFin.Text), "yyyymmdd"))
   End If
End Sub
...
Private Sub cmd_Imprim_Click()
   ...
   If chk_Produc.Value = 0 Then
      crp_Imprim.SelectionFormula = crp_Imprim.SelectionFormula & "{CRE_SOLMAE.SOLMAE_CODPRD} = '" & l_arr_Produc(cmb_Produc.ListIndex + 1).Genera_Codigo & "' AND "
   End If
   ...
   crp_Imprim.ReportFileName = g_str_RutRpt & "\" & "CRE_EVAHIP_08.RPT"
