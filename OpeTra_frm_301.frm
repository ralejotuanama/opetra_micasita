...
Begin VB.Form frm_Tra_AutDes_01 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel2 
         ...
         Begin VB.CommandButton cmd_EvaSol 
            Height          =   585
            Left            =   30
            Picture         =   "OpeTra_frm_301.frx":000C
            Style           =   1  'Graphical
            TabIndex        =   3
            Top             =   30
            Width           =   585
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   13410
            Picture         =   "OpeTra_frm_301.frx":08D6
            Style           =   1  'Graphical
            TabIndex        =   2
            ToolTipText     =   "Salir"
            Top             =   30
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "OpeTra_frm_301.frx":0D18
            Top             =   60
            Width           =   480
         End
      End
   End
End
Attribute VB_Name = "frm_Tra_AutDes_01"
...
Private Sub fs_Buscar()
   ...
   g_str_Parame = g_str_Parame & " INNER JOIN TRA_SEGUIM B ON B.SEGUIM_NUMSOL = A.SOLMAE_NUMERO AND B.SEGUIM_CODINS = 72 AND (B.SEGUIM_SITUAC = 9 OR B.SEGUIM_SITUAC = 3) "
   g_str_Parame = g_str_Parame & " INNER JOIN CLI_DATGEN C ON C.DATGEN_TIPDOC = A.SOLMAE_TITTDO AND C.DATGEN_NUMDOC = A.SOLMAE_TITNDO "
   g_str_Parame = g_str_Parame & " INNER JOIN MNT_PARDES D ON D.PARDES_CODGRP = 23 AND D.PARDES_CODITE = B.SEGUIM_SITUAC "
   g_str_Parame = g_str_Parame & " WHERE SOLMAE_SITUAC = 1 "
   g_str_Parame = g_str_Parame & "   AND SOLMAE_CODINS = 72 "
   ...
   If Not (g_rst_Princi.BOF And g_rst_Princi.EOF) Then
      ...
      Do While Not g_rst_Princi.EOF
         ...
         'g_str_Parame = g_str_Parame & " WHERE SEGUIM_NUMSOL = '" & g_rst_Princi!SOLMAE_NUMERO & "' "
         'g_str_Parame = g_str_Parame & "   AND SEGUIM_CODINS = 72 "
         'g_str_Parame = g_str_Parame & "   AND (SEGUIM_SITUAC = 9 OR SEGUIM_SITUAC = 3)"
         ...
         '   g_rst_Genera.MoveFirst
            ...
            grd_Listad.Col = 6
            grd_Listad.Text = g_rst_Princi!SITUACION 'moddat_gf_Consulta_ParDes("023", CStr(g_rst_Genera!SEGUIM_SITUAC))
