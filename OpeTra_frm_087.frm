   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "OpeTra_frm_087.frx":000C
            Top             =   60
            Width           =   480
         End
      End
      ...
      Begin Threed.SSPanel SSPanel4 
         ...
         Begin VB.CommandButton cmd_Grabar 
            Height          =   585
            Left            =   30
            Picture         =   "OpeTra_frm_087.frx":0316
            Style           =   1  'Graphical
            TabIndex        =   47
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   10560
            Picture         =   "OpeTra_frm_087.frx":0758
            Style           =   1  'Graphical
            TabIndex        =   48
            ToolTipText     =   "Salir"
            Top             =   30
      ...
      Begin Threed.SSPanel SSPanel2 
         ...
         Begin TabDlg.SSTab tab_Genera 
            ...
            TabPicture(0)   =   "OpeTra_frm_087.frx":0B9A
            ...
            TabPicture(1)   =   "OpeTra_frm_087.frx":0BB6
            ...
            TabPicture(2)   =   "OpeTra_frm_087.frx":0BD2
            ...
            Tab(2).Control(16)=   "Label36"
            Tab(2).Control(17)=   "Label37"
            Tab(2).Control(18)=   "Label38"
            Tab(2).Control(19)=   "Label39"
            Tab(2).ControlCount=   20
            TabCaption(3)   =   "Depósito"
            TabPicture(3)   =   "OpeTra_frm_087.frx":0BEE
...
'      End If
   ...
   If moddat_g_str_CodPrd = "001" Or moddat_g_str_CodPrd = "003" Or moddat_g_str_CodPrd = "004" Or moddat_g_str_CodPrd = "007" Then
   ...
   Call moddat_gf_Consulta_ValSeg(moddat_g_str_CodPrd, moddat_g_str_CodSub, l_str_EmpSeg, Format(l_int_TipSeg, "000"), moddat_g_int_TipMon, l_dbl_MtoPre, r_int_TipVal_Des, r_dbl_Import_Des)
   Call moddat_gf_Consulta_ValSeg(moddat_g_str_CodPrd, moddat_g_str_CodSub, l_str_EmpSeg, 0, moddat_g_int_TipMon, r_dbl_ValViv, r_int_TipVal_Viv, r_dbl_Import_Viv)
   ...
   Select Case moddat_g_str_CodPrd
      Case "002"
         Call gs_Cronog_MiCasita(l_arr_CliNCo(), r_dbl_ValViv, l_dbl_MtoPre, l_int_PlaAno * 12, 2, l_dbl_TasInt, r_dbl_Import_Des, 1, r_dbl_Import_Viv, r_dbl_Portes, Format(Date, "dd/mm/yyyy"), l_int_DiaPag, l_int_PerGra, l_dbl_IntGra, 2)
      ...
      Case "003"
         ...
         Call gs_Cronog_CME_NC(l_arr_CliNCo(), l_dbl_MtoPre, r_dbl_PorCon, r_dbl_TopCon, r_dbl_ValViv, l_int_PlaAno * 12, l_int_PerGra, l_dbl_TasInt, r_dbl_Import_Des, 1, r_dbl_Import_Viv, r_dbl_Portes, Format(Date, "dd/mm/yyyy"), l_int_DiaPag, r_dbl_MtoNCo, r_dbl_MtoCon, l_dbl_IntGra, 2)
      ...
      Case "004"
         ...
         Call gs_Cronog_Mihogar_NC(l_arr_CliNCo(), l_dbl_MtoPre, r_dbl_TopCon, r_dbl_ValViv, l_int_PlaAno * 12, l_int_PerGra, l_dbl_TasInt, r_dbl_Import_Des, 1, r_dbl_Import_Viv, r_dbl_Portes, Format(Date, "dd/mm/yyyy"), l_int_DiaPag, r_dbl_MtoNCo, r_dbl_MtoCon, l_dbl_IntGra, 2)
