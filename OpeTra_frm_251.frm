...
Begin VB.Form frm_Rpt_TraCof_07 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin Threed.SSPanel SSPanel7 
            ...
            _ExtentY        =   503
            _StockProps     =   15
            Caption         =   "Reporte de Solicitudes con Aprobación Condicionada Trámites COFIDE"
            ForeColor       =   32768
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "MS Sans Serif"
               Size            =   8.25
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "OpeTra_frm_251.frx":000C
            Top             =   60
            Width           =   480
         End
      End
      Begin Threed.SSPanel SSPanel4 
         ...
         Begin VB.CommandButton cmd_ExpExc 
            Height          =   585
            Left            =   630
            Picture         =   "OpeTra_frm_251.frx":0316
            Style           =   1  'Graphical
            TabIndex        =   3
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   7050
            Picture         =   "OpeTra_frm_251.frx":0620
            Style           =   1  'Graphical
            TabIndex        =   4
            ToolTipText     =   "Salir"
            Top             =   30
         ...
         Begin VB.CommandButton cmd_Imprim 
            Height          =   585
            Left            =   30
            Picture         =   "OpeTra_frm_251.frx":0A62
            Style           =   1  'Graphical
            TabIndex        =   2
   ...
   End
End
Attribute VB_Name = "frm_Rpt_TraCof_07"
...
Private Sub cmd_ExpExc_Click()
   ...
   If chk_ConHip.Value = 0 Then
      Call modmip_gs_Exc_AprCon(62, 2, l_arr_ConHip(cmb_ConHip.ListIndex + 1).Genera_Codigo)
   Else
      Call modmip_gs_Exc_AprCon(62, 2, "")
   End If
...
Private Sub cmd_Imprim_Click()
   ...
   If chk_ConHip.Value = 0 Then
      Call modmip_gs_Rpt_AprCon("CRE_EVAHIP_07.RPT", 1, l_arr_ConHip(cmb_ConHip.ListIndex + 1).Genera_Codigo, 62, "")
   Else
      Call modmip_gs_Rpt_AprCon("CRE_EVAHIP_07.RPT", 1, "", 62, "")
   End If
