...
Begin VB.Form frm_Tra_PolSeg_02 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel4 
         ...
         Begin TabDlg.SSTab tab_Seguim 
            ...
            TabPicture(0)   =   "OpeTra_frm_284.frx":000C
            ...
            TabPicture(1)   =   "OpeTra_frm_284.frx":0028
            ...
            TabPicture(2)   =   "OpeTra_frm_284.frx":0044
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   30
            Picture         =   "OpeTra_frm_284.frx":0074
            Top             =   60
            Width           =   480
         End
      End
      Begin Threed.SSPanel SSPanel36 
         ...
         Begin VB.CommandButton cmd_Evalua 
            Height          =   585
            Left            =   30
            Picture         =   "OpeTra_frm_284.frx":037E
            Style           =   1  'Graphical
            TabIndex        =   46
         ...
         Begin VB.CommandButton cmd_NueObs 
            Height          =   585
            Left            =   630
            Picture         =   "OpeTra_frm_284.frx":0688
            Style           =   1  'Graphical
            TabIndex        =   45
         ...
         Begin VB.CommandButton cmd_Excepc 
            Height          =   585
            Left            =   1230
            Picture         =   "OpeTra_frm_284.frx":0ACA
            Style           =   1  'Graphical
            TabIndex        =   44
         ...
         Begin VB.CommandButton cmd_AprCon 
            Height          =   585
            Left            =   1830
            Picture         =   "OpeTra_frm_284.frx":0DD4
            Style           =   1  'Graphical
            TabIndex        =   43
         ...
         Begin VB.CommandButton cmd_Rechaz 
            Height          =   585
            Left            =   3030
            Picture         =   "OpeTra_frm_284.frx":10DE
            Style           =   1  'Graphical
            TabIndex        =   42
         ...
         Begin VB.CommandButton cmd_Aprueb 
            Height          =   585
            Left            =   2430
            Picture         =   "OpeTra_frm_284.frx":1520
            Style           =   1  'Graphical
            TabIndex        =   41
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   10920
            Picture         =   "OpeTra_frm_284.frx":182A
            Style           =   1  'Graphical
            TabIndex        =   40
            ToolTipText     =   "Salir"
            Top             =   30
   ...
   End
End
Attribute VB_Name = "frm_Tra_PolSeg_02"
...
Dim r_int_NumExc     As Integer
   ...
   If moddat_g_int_FlgAct_1 = 2 Then
      ...
      modgen_g_str_Mail_Asunto = "EMISION DE POLIZAS DE SEGUROS - EXCEPCION (Cliente: " & CStr(moddat_g_int_TipDoc) & "-" & moddat_g_str_NumDoc & " - " & moddat_g_str_NomCli & ")"
      modgen_g_str_Mail_Mensaj = ""
      modgen_g_str_Mail_Mensaj = modgen_g_str_Mail_Mensaj & "NUMERO DE SOLICITUD : " & pnl_NumSol.Caption & Chr(13)
      modgen_g_str_Mail_Mensaj = modgen_g_str_Mail_Mensaj & "ID CLIENTE          : " & CStr(moddat_g_int_TipDoc) & "-" & moddat_g_str_NumDoc & Chr(13)
      modgen_g_str_Mail_Mensaj = modgen_g_str_Mail_Mensaj & "NOMBRE CLIENTE      : " & moddat_g_str_NomCli & Chr(13)
...
Dim r_int_NumObs     As Integer
   ...
   If moddat_g_int_FlgAct_1 = 2 Then
      ...
      If moddat_g_int_TipObs = 1 Then
         ...
         g_str_Parame = g_str_Parame & "   AND SEGDET_CODINS = 61 "
         ...
         'Enviando Correo Electrónico
         modgen_g_str_Mail_Asunto = "EMISION DE POLIZAS DE SEGUROS - OBSERVACION (Cliente: " & CStr(moddat_g_int_TipDoc) & "-" & moddat_g_str_NumDoc & " - " & moddat_g_str_NomCli & ")"
      Else
         modgen_g_str_Mail_Asunto = "EMISION DE POLIZAS DE SEGUROS - COMENTARIO (Cliente: " & CStr(moddat_g_int_TipDoc) & "-" & moddat_g_str_NumDoc & " - " & moddat_g_str_NomCli & ")"
...
Private Sub cmd_Rechaz_Click()
   ...
   If moddat_g_int_MotRec > 0 Then
      ...
      modgen_g_str_Mail_Asunto = "EMISION DE POLIZAS DE SEGUROS - RECHAZO (Cliente: " & CStr(moddat_g_int_TipDoc) & "-" & moddat_g_str_NumDoc & " - " & moddat_g_str_NomCli & ")"
      modgen_g_str_Mail_Mensaj = ""
      modgen_g_str_Mail_Mensaj = modgen_g_str_Mail_Mensaj & "NUMERO DE SOLICITUD : " & pnl_NumSol.Caption & Chr(13)
      modgen_g_str_Mail_Mensaj = modgen_g_str_Mail_Mensaj & "ID CLIENTE          : " & CStr(moddat_g_int_TipDoc) & "-" & moddat_g_str_NumDoc & Chr(13)
      modgen_g_str_Mail_Mensaj = modgen_g_str_Mail_Mensaj & "NOMBRE CLIENTE      : " & moddat_g_str_NomCli & Chr(13)
...
Private Sub fs_Buscar_DatEva()
   ...
   g_str_Parame = ""
   g_str_Parame = g_str_Parame & "SELECT * FROM TRA_POLIZA "
