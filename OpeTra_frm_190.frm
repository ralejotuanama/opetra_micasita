...
Begin VB.Form frm_Seg_SolHip_66 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel3 
         ...
         Begin TabDlg.SSTab tab_Seguim 
            ...
            TabPicture(0)   =   "OpeTra_frm_190.frx":000C
            ...
            TabPicture(1)   =   "OpeTra_frm_190.frx":0028
            ...
            TabPicture(2)   =   "OpeTra_frm_190.frx":0044
            ...
            TabPicture(3)   =   "OpeTra_frm_190.frx":0060
            Tab(3).ControlEnabled=   0   'False
            Tab(3).Control(0)=   "Label10"
            Tab(3).Control(1)=   "Label19"
            Tab(3).Control(2)=   "pnl_MotRec"
            Tab(3).Control(3)=   "txt_ObsRec"
      ...
      Begin Threed.SSPanel SSPanel2 
         ...
         Begin TabDlg.SSTab SSTab1 
            ...
            TabPicture(5)   =   "OpeTra_frm_190.frx":011C
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "OpeTra_frm_190.frx":013C
            Top             =   60
            Width           =   480
         End
      End
      ...
      Begin Threed.SSPanel SSPanel39 
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   10920
            Picture         =   "OpeTra_frm_190.frx":0446
            Style           =   1  'Graphical
            TabIndex        =   57
            ToolTipText     =   "Salir"
            Top             =   30
   ...
   End
End
Attribute VB_Name = "frm_Seg_SolHip_66"
...
Private Sub fs_Buscar_AceCli()
   ...
   If g_rst_Princi!SOLMAE_INMIDE = 1 Then
      ...
      If g_rst_Princi!SOLMAE_TIPMON = 2 Then
         ...
         grd_LisEva.Row = grd_LisEva.Rows - 1
         grd_LisEva.Col = 0
         grd_LisEva.Text = "Monto Préstamo"
      ...
      grd_LisEva.Col = 1
      grd_LisEva.Text = CStr(g_rst_Princi!SOLMAE_PLAANO) & " Años"
      ...
      grd_LisEva.Col = 1
      grd_LisEva.Text = moddat_gf_Consulta_ParDes("277", CStr(g_rst_Princi!SOLMAE_CUOEXT))
