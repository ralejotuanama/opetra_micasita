...
Begin VB.Form frm_Lev_PolSeg_01 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel2 
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   13410
            Picture         =   "OpeTra_frm_316.frx":000C
            Style           =   1  'Graphical
            TabIndex        =   3
            ToolTipText     =   "Salir"
            Top             =   30
         ...
         Begin VB.CommandButton cmd_EvaCre 
            Height          =   585
            Left            =   30
            Picture         =   "OpeTra_frm_316.frx":044E
            Style           =   1  'Graphical
            TabIndex        =   2
            Top             =   30
            Width           =   585
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "OpeTra_frm_316.frx":0D18
            Top             =   60
            Width           =   480
         End
      End
   End
End
Attribute VB_Name = "frm_Lev_PolSeg_01"
...
Private Sub fs_Buscar()
   ...
   g_str_Parame = g_str_Parame & "   AND SEGCON_CODINS = 61 "
   ...
   If Not (g_rst_Princi.BOF And g_rst_Princi.EOF) Then
      ...
      Do While Not g_rst_Princi.EOF
         ...
         g_str_Parame = "SELECT * FROM TRA_SEGCON WHERE SEGCON_NUMSOL = '" & g_rst_Princi!SOLMAE_NUMERO & "' AND SEGCON_CODINS = 61 "
