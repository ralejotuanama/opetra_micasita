...
Begin VB.Form frm_TraMVi_03 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "OpeTra_frm_043.frx":0000
            Top             =   60
            Width           =   480
         End
      End
      ...
      Begin Threed.SSPanel SSPanel4 
         ...
         Begin VB.CommandButton cmd_Grabar 
            Height          =   675
            Left            =   9780
            Picture         =   "OpeTra_frm_043.frx":030A
            Style           =   1  'Graphical
            TabIndex        =   19
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   675
            Left            =   10470
            Picture         =   "OpeTra_frm_043.frx":074C
            Style           =   1  'Graphical
            TabIndex        =   18
            ToolTipText     =   "Salir"
            Top             =   30
   ...
   End
End
Attribute VB_Name = "frm_TraMVi_03"
...
Private Sub cmd_Grabar_Click()
   ...
   Do While moddat_g_int_FlgGOK = False
      ...
      g_str_Parame = "USP_TRA_EVAMVI_ENVIAR ("
...
Private Sub fs_Buscar_DatEva()
   ...
   If Not (g_rst_Princi.BOF And g_rst_Princi.EOF) Then
      ...
      ipp_FecEnv.Text = gf_FormatoFecha(g_rst_Princi!EVAMVI_FECENV)
   End If
