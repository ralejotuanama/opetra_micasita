...
Begin VB.Form frm_Rpt_EvaSeg_03 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin Threed.SSPanel SSPanel7 
            ...
            _ExtentY        =   503
            _StockProps     =   15
            Caption         =   "Reporte de Solicitudes en Evaluación de Seguros"
            ForeColor       =   32768
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "MS Sans Serif"
               Size            =   8.25
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "OpeTra_frm_229.frx":000C
            Top             =   60
            Width           =   480
         End
      End
      Begin Threed.SSPanel SSPanel4 
         ...
         Begin VB.CommandButton cmd_Imprim 
            Height          =   585
            Left            =   30
            Picture         =   "OpeTra_frm_229.frx":0316
            Style           =   1  'Graphical
            TabIndex        =   4
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   5340
            Picture         =   "OpeTra_frm_229.frx":0758
            Style           =   1  'Graphical
            TabIndex        =   6
            ToolTipText     =   "Salir"
            Top             =   30
         ...
         Begin VB.CommandButton cmd_ExpExc 
            Height          =   585
            Left            =   630
            Picture         =   "OpeTra_frm_229.frx":0B9A
            Style           =   1  'Graphical
            TabIndex        =   5
   ...
   End
End
Attribute VB_Name = "frm_Rpt_EvaSeg_03"
...
Private Sub cmd_ExpExc_Click()
   ...
   Call modmip_gs_Exc_Tramit_Dbl(41, 42, 3, r_str_CodMod, r_str_PrySel)
...
Private Sub cmd_Imprim_Click()
   ...
   If chk_TipPry.Value = 0 Then
      If chk_CodPry.Value = 0 And chk_CodPry.Enabled = True Then
         Call modmip_gs_Rpt_EvaIns_Dbl("CRE_EVAHIP_03.RPT", 3, Format(cmb_TipPry.ItemData(cmb_TipPry.ListIndex), "00"), 41, 42, l_arr_CodPry(cmb_CodPry.ListIndex + 1).Genera_Codigo)
      Else
         Call modmip_gs_Rpt_EvaIns_Dbl("CRE_EVAHIP_03.RPT", 3, Format(cmb_TipPry.ItemData(cmb_TipPry.ListIndex), "00"), 41, 42, "")
      End If
   Else
      Call modmip_gs_Rpt_EvaIns_Dbl("CRE_EVAHIP_03.RPT", 1, "", 41, 42, "")
   End If
