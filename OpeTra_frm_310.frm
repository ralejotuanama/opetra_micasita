...
Begin VB.Form frm_Tra_TraCof_05 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin Threed.SSPanel SSPanel8 
            ...
            _ExtentY        =   503
            _StockProps     =   15
            Caption         =   "Recepción de Documentos a COFIDE"
            ForeColor       =   32768
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "MS Sans Serif"
               Size            =   8.25
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "OpeTra_frm_310.frx":0010
            Top             =   60
            Width           =   480
         End
      End
      ...
      Begin Threed.SSPanel SSPanel4 
         ...
         Begin VB.CommandButton cmd_Grabar 
            Height          =   585
            Left            =   30
            Picture         =   "OpeTra_frm_310.frx":031A
            Style           =   1  'Graphical
            TabIndex        =   6
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   10560
            Picture         =   "OpeTra_frm_310.frx":075C
            Style           =   1  'Graphical
            TabIndex        =   7
            ToolTipText     =   "Salir"
            Top             =   30
   ...
   End
End
Attribute VB_Name = "frm_Tra_TraCof_05"
...
Private Sub cmd_Grabar_Click()
   ...
   If CDate(ipp_FecRec.Text) > date Then
      ...
      Exit Sub
   End If
   If Len(Trim(txt_CodPre.Text)) = 0 Then
      MsgBox "Debe registrar el código de prestatario.", vbExclamation, modgen_g_str_NomPlt
      Call gs_SetFocus(txt_CodPre)
      Exit Sub
   End If
   ...
   Do While moddat_g_int_FlgGOK = False
      ...
      g_str_Parame = g_str_Parame & "'" & Trim(txt_NumCar.Text) & "', "
      g_str_Parame = g_str_Parame & Format(CDate(ipp_FecRec.Text), "yyyymmdd") & ", "
      g_str_Parame = g_str_Parame & "'" & Trim(txt_CodMVi.Text) & "', "
      ...
      g_str_Parame = g_str_Parame & "'" & Trim(txt_CodPre.Text) & "', "
   ...
   If Not moddat_gf_Inserta_SegDet(moddat_g_str_NumSol, 62, 37, 0, "", 0, 0) Then
      Exit Sub
   End If
...
Private Sub fs_Buscar_DatEva()
   'Obtiene datos del documento cofide
   g_str_Parame = ""
   ...
   If Not (g_rst_Princi.BOF And g_rst_Princi.EOF) Then
      ...
      txt_CodPre.Text = Trim(g_rst_Princi!EVACOF_CODMV1 & "")
   ...
   'Obtiene codigo del prestatario
   g_str_Parame = ""
   g_str_Parame = g_str_Parame & "SELECT HIPMAE_CODCOF "
   ...
   If Not (g_rst_Princi.BOF And g_rst_Princi.EOF) Then
      txt_CodPre.Text = g_rst_Princi!HIPMAE_CODCOF
   End If
...
Private Sub txt_CodPre_GotFocus()
   Call gs_SelecTodo(txt_CodPre)
End Sub

Private Sub txt_CodPre_KeyPress(KeyAscii As Integer)
   If KeyAscii = 13 Then
      Call gs_SetFocus(txt_CodMVi)
   Else
      KeyAscii = gf_ValidaCaracter(KeyAscii, modgen_g_con_LETRAS & modgen_g_con_NUMERO)
