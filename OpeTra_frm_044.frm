...
Begin VB.Form frm_TraMVi_04 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "OpeTra_frm_044.frx":0010
            Top             =   60
            Width           =   480
         End
      End
      ...
      Begin Threed.SSPanel SSPanel4 
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   675
            Left            =   10470
            Picture         =   "OpeTra_frm_044.frx":031A
            Style           =   1  'Graphical
            TabIndex        =   19
            ToolTipText     =   "Salir"
            Top             =   30
         ...
         Begin VB.CommandButton cmd_Grabar 
            Height          =   675
            Left            =   9780
            Picture         =   "OpeTra_frm_044.frx":075C
            Style           =   1  'Graphical
            TabIndex        =   18
   ...
   End
End
Attribute VB_Name = "frm_TraMVi_04"
...
Private Sub cmd_Grabar_Click()
   If CDate(ipp_FecRec.Text) > Date Then
      MsgBox "La Fecha de Recepción no puede ser mayor a la Fecha Actual.", vbExclamation, modgen_g_str_NomPlt
      Call gs_SetFocus(ipp_FecRec)
      Exit Sub
   End If

   If Len(Trim(txt_CodMVi.Text)) = 0 Then
      MsgBox "Debe registrar el Código Expediente Mivivienda.", vbExclamation, modgen_g_str_NomPlt
   ...
   Do While moddat_g_int_FlgGOK = False
      ...
      g_str_Parame = "USP_TRA_EVAMVI_RECEPCIONAR ("
...
Private Sub fs_Buscar_DatEva()
   ...
   If Not (g_rst_Princi.BOF And g_rst_Princi.EOF) Then
      ...
      ipp_FecRec.Text = gf_FormatoFecha(g_rst_Princi!EVAMVI_FECREC)
      txt_CodMVi.Text = Trim(g_rst_Princi!EVAMVI_CODMVI & "")
