...
Begin VB.Form frm_Rpt_PolSeg_02 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "OpeTra_frm_231.frx":000C
            Top             =   60
            Width           =   480
         End
      End
      Begin Threed.SSPanel SSPanel4 
         ...
         Begin VB.CommandButton cmd_Imprim 
            Height          =   585
            Left            =   30
            Picture         =   "OpeTra_frm_231.frx":0316
            Style           =   1  'Graphical
            TabIndex        =   2
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   4740
            Picture         =   "OpeTra_frm_231.frx":0758
            Style           =   1  'Graphical
            TabIndex        =   4
            ToolTipText     =   "Salir"
            Top             =   30
         ...
         Begin VB.CommandButton cmd_ExpExc 
            Height          =   585
            Left            =   630
            Picture         =   "OpeTra_frm_231.frx":0B9A
            Style           =   1  'Graphical
            TabIndex        =   3
   ...
   End
End
Attribute VB_Name = "frm_Rpt_PolSeg_02"
...
Private Sub cmd_ExpExc_Click()
   ...
   If chk_ConHip.Value = 0 Then
      Call modmip_gs_Exc_Tramit_Dbl(61, 61, 2, l_arr_ConHip(cmb_ConHip.ListIndex + 1).Genera_Codigo, "")
   Else
      Call modmip_gs_Exc_Tramit_Dbl(61, 61, 2, "", "")
   End If
...
Private Sub cmd_Imprim_Click()
   ...
   If chk_ConHip.Value = 0 Then
      Call modmip_gs_Rpt_EvaIns_Dbl("CRE_EVAHIP_02.RPT", 2, l_arr_ConHip(cmb_ConHip.ListIndex + 1).Genera_Codigo, 61, 61, "")
   Else
      Call modmip_gs_Rpt_EvaIns_Dbl("CRE_EVAHIP_02.RPT", 2, "", 61, 61, "")
   End If
