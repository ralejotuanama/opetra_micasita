   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel2 
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   13380
            Picture         =   "OpeTra_frm_058.frx":000C
            Style           =   1  'Graphical
            TabIndex        =   3
            ToolTipText     =   "Salir"
            Top             =   30
         ...
         Begin VB.CommandButton cmd_Evalua 
            Height          =   585
            Left            =   30
            Picture         =   "OpeTra_frm_058.frx":044E
            Style           =   1  'Graphical
            TabIndex        =   2
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "OpeTra_frm_058.frx":0D18
            Top             =   60
            Width           =   480
         End
      End
...
Private Sub cmd_Evalua_Click()
   ...
   'frm_TraCof_02.Show 1
   frm_TraCof_11.Show 1
...
Private Sub fs_Buscar()
   ...
   g_str_Parame = g_str_Parame & "(SOLMAE_CODPRD = '004' OR SOLMAE_CODPRD = '003' OR SOLMAE_CODPRD = '007' OR SOLMAE_CODPRD = '009' OR SOLMAE_CODPRD = '010') "
   ...
   If grd_Listad.Rows = 0 Then
      ...
      MsgBox "No se encontraron Solicitudes Pendientes de Trámites Cofide.", vbInformation, modgen_g_str_NomPlt
   Else
