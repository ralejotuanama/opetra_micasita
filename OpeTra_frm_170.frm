...
Begin VB.Form frm_MntCli_60 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel8 
         ...
         Begin VB.CommandButton cmd_Buscar 
            Height          =   585
            Left            =   9780
            Picture         =   "OpeTra_frm_170.frx":000C
            Style           =   1  'Graphical
            TabIndex        =   2
         ...
         Begin VB.CommandButton cmd_Limpia 
            Height          =   585
            Left            =   10380
            Picture         =   "OpeTra_frm_170.frx":0316
            Style           =   1  'Graphical
            TabIndex        =   3
         ...
         Begin VB.CommandButton cmd_Editar 
            Height          =   585
            Left            =   10980
            Picture         =   "OpeTra_frm_170.frx":0620
            Style           =   1  'Graphical
            TabIndex        =   4
            Top             =   60
            Width           =   585
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin Threed.SSPanel SSPanel7 
            ...
            _ExtentY        =   450
            _StockProps     =   15
            Caption         =   "Actividades Económicas - Accionista"
            ForeColor       =   32768
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "MS Sans Serif"
               Size            =   8.25
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "OpeTra_frm_170.frx":092A
            Top             =   60
            Width           =   480
         End
      End
      ...
      Begin Threed.SSPanel SSPanel9 
         ...
         Begin VB.CommandButton cmd_Grabar 
            Height          =   585
            Left            =   30
            Picture         =   "OpeTra_frm_170.frx":0C34
            Style           =   1  'Graphical
            TabIndex        =   9
            Top             =   30
            Width           =   585
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   10980
            Picture         =   "OpeTra_frm_170.frx":1076
            Style           =   1  'Graphical
            TabIndex        =   10
            Top             =   30
            Width           =   585
   ...
   End
End
Attribute VB_Name = "frm_MntCli_60"
...
Private Sub cmd_Grabar_Click()
   ...
   g_str_Parame = g_str_Parame & "41, "                                                      'Código Actividad Económica (Accionista)
   ...
   g_str_Parame = g_str_Parame & "0, "                                                    'Porcentaje Participación
   g_str_Parame = g_str_Parame & Format(CDate(ipp_FecIng.Text), "yyyymmdd") & ", "        'Fecha antigüedad
...
Private Sub Form_Load()
   ...
   If modmip_g_int_FlgGrb_1 = 2 Then
      ...
      Call gs_BuscarCombo_Item(cmb_TipDoc, g_rst_Princi!ActEco_Acc_TipDoc)
      txt_NumDoc.Text = Trim(g_rst_Princi!ActEco_Acc_NumDoc)
      ...
      Call gs_BuscarCombo_Item(cmb_MonIng, g_rst_Princi!ActEco_acc_MonIng)
      
      ipp_IngNet.Value = g_rst_Princi!ActEco_Acc_IngNet
      ipp_FecIng.Text = gf_FormatoFecha(CStr(g_rst_Princi!ActEco_Acc_FecAnt))
