...
Begin VB.Form frm_Lev_TraCof_01 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel2 
         ...
         Begin VB.CommandButton cmd_EvaCre 
            Height          =   585
            Left            =   30
            Picture         =   "OpeTra_frm_318.frx":000C
            Style           =   1  'Graphical
            TabIndex        =   3
            Top             =   30
            Width           =   585
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   13410
            Picture         =   "OpeTra_frm_318.frx":08D6
            Style           =   1  'Graphical
            TabIndex        =   2
            ToolTipText     =   "Salir"
            Top             =   30
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "OpeTra_frm_318.frx":0D18
            Top             =   60
            Width           =   480
         End
      End
   End
End
Attribute VB_Name = "frm_Lev_TraCof_01"
...
Private Sub fs_Buscar()
   ...
   g_str_Parame = g_str_Parame & "   AND SEGCON_CODINS = 62 "
   ...
   If Not (g_rst_Princi.BOF And g_rst_Princi.EOF) Then
      ...
      Do While Not g_rst_Princi.EOF
         ...
         g_str_Parame = "SELECT * FROM TRA_SEGCON WHERE SEGCON_NUMSOL = '" & g_rst_Princi!SOLMAE_NUMERO & "' AND SEGCON_CODINS = 62 "
