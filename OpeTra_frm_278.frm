...
Begin VB.Form frm_Tra_EvaTas_04 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin Threed.SSPanel SSPanel15 
            ...
            _ExtentY        =   503
            _StockProps     =   15
            Caption         =   "Registro de Informe del Perito"
            ForeColor       =   32768
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "MS Sans Serif"
               Size            =   8.25
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "OpeTra_frm_278.frx":000C
            Top             =   60
            Width           =   480
         End
      End
      ...
      Begin Threed.SSPanel SSPanel4 
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   10560
            Picture         =   "OpeTra_frm_278.frx":0316
            Style           =   1  'Graphical
            TabIndex        =   50
            ToolTipText     =   "Salir"
            Top             =   30
         ...
         Begin VB.CommandButton cmd_Grabar 
            Height          =   585
            Left            =   30
            Picture         =   "OpeTra_frm_278.frx":0758
            Style           =   1  'Graphical
            TabIndex        =   49
      ...
      Begin Threed.SSPanel SSPanel2 
         ...
         Begin TabDlg.SSTab tab_Genera 
            ...
            TabPicture(0)   =   "OpeTra_frm_278.frx":0B9A
            ...
            TabPicture(1)   =   "OpeTra_frm_278.frx":0BB6
            ...
            TabPicture(2)   =   "OpeTra_frm_278.frx":0BD2
            ...
            TabPicture(3)   =   "OpeTra_frm_278.frx":0BEE
   ...
   End
End
Attribute VB_Name = "frm_Tra_EvaTas_04"
...
'      End If
   ...
   If InStr(moddat_g_str_AgrCRC, moddat_g_str_CodPrd) > 0 Or InStr(moddat_g_str_AgrCME, moddat_g_str_CodPrd) > 0 Then
   ...
   If InStr(moddat_g_str_AgrCRC, moddat_g_str_CodPrd) > 0 Or InStr(moddat_g_str_AgrCME, moddat_g_str_CodPrd) > 0 Or InStr(moddat_g_str_AgrTFMV, moddat_g_str_CodPrd) > 0 Then
      ...
      End If
      If Not (CDbl(pnl_ValCom.Caption) / l_dbl_MtoPre * 100 >= r_dbl_PorMin_ValGrv) Then
         MsgBox "La relación Valor Comercial / Monto de Préstamo no cumple con el Parámetro permitido para el Producto." & Format(CDbl(pnl_ValCom.Caption) / l_dbl_MtoPre * 100, "##0.00") & "%", vbExclamation, modgen_g_str_NomPlt
         Exit Sub
      End If
   
      'Determinando Valor de la Garantía
      If CDbl(pnl_ValCom.Caption) < l_dbl_ComVta Then
         r_dbl_ValGar = CDbl(pnl_ValCom.Caption)
      Else
         r_dbl_ValGar = l_dbl_ComVta
      End If
      ...
      End If
      If Not (l_dbl_MtoPre / r_dbl_ValGar * 100 <= r_dbl_PorMax_ValGar) Then
         MsgBox "La relación Monto del Préstamo / Valor de la Garantía no cumple con el Parámetro permitido para el Producto." & Format(l_dbl_MtoPre / r_dbl_ValGar * 100, "##0.00") & "%", vbExclamation, modgen_g_str_NomPlt
         Exit Sub
      End If
      ...
      If moddat_gf_Consulta_ParSubPrd(l_arr_ParPrd, moddat_g_str_CodPrd, moddat_g_str_CodSub, "051", "033") Then
         r_dbl_PorMax_ValGar = l_arr_ParPrd(1).Genera_Cantid
      End If
      If Not ((l_dbl_MtoPre + l_dbl_IntCap) / r_dbl_ValGar * 100 <= r_dbl_PorMax_ValGar) Then
         MsgBox "La relación Monto del Préstamo + Intereses Capitalizados / Valor de la Garantía no cumple con el Parámetro permitido para el Producto." & Format((l_dbl_MtoPre + l_dbl_IntCap) / r_dbl_ValGar * 100, "##0.00") & "%", vbExclamation, modgen_g_str_NomPlt
         Exit Sub
      End If
   End If
   ...
   If moddat_g_str_CodPrd = "002" Then
      If modgen_g_int_TipUsu = 18200 Or modgen_g_int_TipUsu = 18220 Then
         If l_dbl_MtoPre > CDbl(pnl_ValRea.Caption) Then
   ...
   Select Case moddat_g_str_CodPrd > 0
      'COMENTADO PORQUE EL PRODUCTO ESTA CADUCADO
...
Private Sub fs_Inicia()
   ...
   If Not (g_rst_Princi.BOF And g_rst_Princi.EOF) Then
      ...
      l_dbl_IntCap = g_rst_Princi!SOLMAE_INTGRA
...
Dim r_str_DesExc     As String
   ...
   Else
      r_str_DesExc = moddat_g_str_Msje02
   End If
